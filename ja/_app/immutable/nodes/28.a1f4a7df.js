import{s as za,o as $a,n as ee}from"../chunks/scheduler.9bc65507.js";import{S as Pa,i as Ba,g as r,s as n,r as u,A as Ma,h as a,f as i,c as o,j as y,u as h,x as l,k as x,y as e,a as v,v as f,d as _,t as g,w as k}from"../chunks/index.707bf1b6.js";import{T as Tn}from"../chunks/Tip.c2ecdbf4.js";import{D as w}from"../chunks/Docstring.17db21ae.js";import{C as Sn}from"../chunks/CodeBlock.54a9f38d.js";import{E as Vn}from"../chunks/ExampleCodeBlock.4f515aa9.js";import{H as Dn}from"../chunks/Heading.342b1fa6.js";function qa(B){let s,z="This method is deprecated, <code>__call__</code> should be used instead.";return{c(){s=r("p"),s.innerHTML=z},l(m){s=a(m,"P",{"data-svelte-h":!0}),l(s)!=="svelte-1phrc72"&&(s.innerHTML=z)},m(m,T){v(m,s,T)},p:ee,d(m){m&&i(s)}}}function Ia(B){let s,z="This method is deprecated, <code>__call__</code> should be used instead.";return{c(){s=r("p"),s.innerHTML=z},l(m){s=a(m,"P",{"data-svelte-h":!0}),l(s)!=="svelte-1phrc72"&&(s.innerHTML=z)},m(m,T){v(m,s,T)},p:ee,d(m){m&&i(s)}}}function ja(B){let s,z="Passing <code>token=True</code> is required when you want to use a private model.";return{c(){s=r("p"),s.innerHTML=z},l(m){s=a(m,"P",{"data-svelte-h":!0}),l(s)!=="svelte-15auxyb"&&(s.innerHTML=z)},m(m,T){v(m,s,T)},p:ee,d(m){m&&i(s)}}}function La(B){let s,z="Examples:",m,T,$;return T=new Sn({props:{code:"",highlighted:`<span class="hljs-comment"># We can&#x27;t instantiate directly the base class *PreTrainedTokenizerBase* so let&#x27;s show our examples on a derived class: BertTokenizer</span>
...
<span class="hljs-keyword">assert</span> tokenizer.unk_token == <span class="hljs-string">&quot;&lt;unk&gt;&quot;</span>`,wrap:!1}}),{c(){s=r("p"),s.textContent=z,m=n(),u(T.$$.fragment)},l(d){s=a(d,"P",{"data-svelte-h":!0}),l(s)!=="svelte-kvfsh7"&&(s.textContent=z),m=o(d),h(T.$$.fragment,d)},m(d,P){v(d,s,P),v(d,m,P),f(T,d,P),$=!0},p:ee,i(d){$||(_(T.$$.fragment,d),$=!0)},o(d){g(T.$$.fragment,d),$=!1},d(d){d&&(i(s),i(m)),k(T,d)}}}function Ca(B){let s,z=`If the <code>encoded_inputs</code> passed are dictionary of numpy arrays, PyTorch tensors or TensorFlow tensors, the
result will use the same type unless you provide a different tensor type with <code>return_tensors</code>. In the case of
PyTorch tensors, you will lose the specific device of your tensors however.`;return{c(){s=r("p"),s.innerHTML=z},l(m){s=a(m,"P",{"data-svelte-h":!0}),l(s)!=="svelte-ppz3re"&&(s.innerHTML=z)},m(m,T){v(m,s,T)},p:ee,d(m){m&&i(s)}}}function Wa(B){let s,z="Examples:",m,T,$;return T=new Sn({props:{code:"",highlighted:`<span class="hljs-keyword">from</span> transformers <span class="hljs-keyword">import</span> AutoTokenizer
...
tokenizer.push_to_hub(<span class="hljs-string">&quot;huggingface/my-finetuned-bert&quot;</span>)`,wrap:!1}}),{c(){s=r("p"),s.textContent=z,m=n(),u(T.$$.fragment)},l(d){s=a(d,"P",{"data-svelte-h":!0}),l(s)!=="svelte-kvfsh7"&&(s.textContent=z),m=o(d),h(T.$$.fragment,d)},m(d,P){v(d,s,P),v(d,m,P),f(T,d,P),$=!0},p:ee,i(d){$||(_(T.$$.fragment,d),$=!0)},o(d){g(T.$$.fragment,d),$=!1},d(d){d&&(i(s),i(m)),k(T,d)}}}function Ua(B){let s,z="This API is experimental and may have some slight breaking changes in the next releases.";return{c(){s=r("p"),s.textContent=z},l(m){s=a(m,"P",{"data-svelte-h":!0}),l(s)!=="svelte-15rpg4"&&(s.textContent=z)},m(m,T){v(m,s,T)},p:ee,d(m){m&&i(s)}}}function Ja(B){let s,z="Examples:",m,T,$;return T=new Sn({props:{code:"",highlighted:`<span class="hljs-comment"># Let&#x27;s see how to add a new classification token to GPT-2</span>
...
<span class="hljs-keyword">assert</span> tokenizer.cls_token == <span class="hljs-string">&quot;&lt;CLS&gt;&quot;</span>`,wrap:!1}}),{c(){s=r("p"),s.textContent=z,m=n(),u(T.$$.fragment)},l(d){s=a(d,"P",{"data-svelte-h":!0}),l(s)!=="svelte-kvfsh7"&&(s.textContent=z),m=o(d),h(T.$$.fragment,d)},m(d,P){v(d,s,P),v(d,m,P),f(T,d,P),$=!0},p:ee,i(d){$||(_(T.$$.fragment,d),$=!0)},o(d){g(T.$$.fragment,d),$=!1},d(d){d&&(i(s),i(m)),k(T,d)}}}function Fa(B){let s,z="Examples:",m,T,$;return T=new Sn({props:{code:"",highlighted:`<span class="hljs-comment"># Let&#x27;s see how to increase the vocabulary of Bert model and tokenizer</span>
...
<span class="hljs-built_in">print</span>(<span class="hljs-string">&quot;We have added&quot;</span>, num_added_toks, <span class="hljs-string">&quot;tokens&quot;</span>)
<span class="hljs-comment"># Notice: resize_token_embeddings expect to receive the full size of the new vocabulary, i.e., the length of the tokenizer.</span>
model.resize_token_embeddings(<span class="hljs-built_in">len</span>(tokenizer))`,wrap:!1}}),{c(){s=r("p"),s.textContent=z,m=n(),u(T.$$.fragment)},l(d){s=a(d,"P",{"data-svelte-h":!0}),l(s)!=="svelte-kvfsh7"&&(s.textContent=z),m=o(d),h(T.$$.fragment,d)},m(d,P){v(d,s,P),v(d,m,P),f(T,d,P),$=!0},p:ee,i(d){$||(_(T.$$.fragment,d),$=!0)},o(d){g(T.$$.fragment,d),$=!1},d(d){d&&(i(s),i(m)),k(T,d)}}}function Na(B){let s,z,m,T,$,d,P,zr=`このページには、トークナイザーによって使用されるすべてのユーティリティ関数 (主にクラス) がリストされます。
<a href="/docs/transformers/main/ja/internal/tokenization_utils#transformers.PreTrainedTokenizerBase">PreTrainedTokenizerBase</a> 間の共通メソッドを実装します。
<a href="/docs/transformers/main/ja/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a> と <a href="/docs/transformers/main/ja/main_classes/tokenizer#transformers.PreTrainedTokenizerFast">PreTrainedTokenizerFast</a> およびミックスイン
<a href="/docs/transformers/main/ja/internal/tokenization_utils#transformers.SpecialTokensMixin">SpecialTokensMixin</a>。`,vn,we,$r="これらのほとんどは、ライブラリ内のトークナイザーのコードを学習する場合にのみ役に立ちます。",yn,ze,xn,c,$e,En,mt,Pr='Base class for <a href="/docs/transformers/main/ja/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a> and <a href="/docs/transformers/main/ja/main_classes/tokenizer#transformers.PreTrainedTokenizerFast">PreTrainedTokenizerFast</a>.',Rn,ut,Br="Handles shared (mostly boiler plate) methods for those two classes.",An,ht,Mr="Class attributes (overridden by derived classes)",Hn,ft,qr=`<li><strong>vocab_files_names</strong> (<code>Dict[str, str]</code>) — A dictionary with, as keys, the <code>__init__</code> keyword name of each
...
applied. Should be <code>&#39;right&#39;</code> or <code>&#39;left&#39;</code>.</li>`,Gn,te,Pe,Xn,_t,Ir=`Main method to tokenize and prepare for the model one or several sequence(s) or one or several pair(s) of
sequences.`,Qn,ne,Be,Yn,gt,jr=`Converts a Conversation object or a list of dictionaries with <code>&quot;role&quot;</code> and <code>&quot;content&quot;</code> keys to a list of token
ids. This method is intended for use with chat models, and will read the tokenizer’s chat_template attribute to
determine the format and control tokens to use when converting. When chat_template is None, it will fall back
to the default_chat_template specified at the class level.`,On,oe,Me,Kn,kt,Lr=`Temporarily sets the tokenizer for encoding the targets. Useful for tokenizer associated to
sequence-to-sequence models that need a slightly different processing for the labels.`,eo,re,qe,to,bt,Cr="Convert a list of lists of token ids into a list of strings by calling decode.",no,U,Ie,oo,Tt,Wr="Tokenize and prepare for the model a list of sequences or a list of pairs of sequences.",ro,ae,ao,J,je,so,vt,Ur=`Build model inputs from a sequence or a pair of sequence for sequence classification tasks by concatenating and
adding special tokens.`,io,yt,Jr="This implementation does not add special tokens and this method should be overridden in a subclass.",co,se,Le,lo,xt,Fr="Clean up a list of simple English tokenization artifacts like spaces before punctuations and abbreviated forms.",po,ie,Ce,mo,wt,Nr=`Converts a sequence of tokens in a single string. The most simple way to do it is <code>&quot; &quot;.join(tokens)</code> but we
often want to remove sub-word tokenization artifacts at the same time.`,uo,F,We,ho,zt,Zr=`Create the token type IDs corresponding to the sequences passed. <a href="../glossary#token-type-ids">What are token type
IDs?</a>`,fo,$t,Vr="Should be overridden in a subclass if the model has a special way of building those.",_o,N,Ue,go,Pt,Dr=`Converts a sequence of ids in a string, using the tokenizer and vocabulary with options to remove special
tokens and clean up tokenization spaces.`,ko,Bt,Sr="Similar to doing <code>self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))</code>.",bo,Z,Je,To,Mt,Er="Converts a string to a sequence of ids (integer), using the tokenizer and vocabulary.",vo,qt,Rr="Same as doing <code>self.convert_tokens_to_ids(self.tokenize(text))</code>.",yo,V,Fe,xo,It,Ar="Tokenize and prepare for the model a sequence or a pair of sequences.",wo,de,zo,C,Ne,$o,jt,Hr=`Instantiate a <a href="/docs/transformers/main/ja/internal/tokenization_utils#transformers.PreTrainedTokenizerBase">PreTrainedTokenizerBase</a> (or a derived class) from a predefined
tokenizer.`,Po,ce,Bo,le,Mo,pe,Ze,qo,Lt,Gr=`Retrieves sequence ids from a token list that has no special tokens added. This method is called when adding
special tokens using the tokenizer <code>prepare_for_model</code> or <code>encode_plus</code> methods.`,Io,D,Ve,jo,Ct,Xr="Returns the vocabulary as a dictionary of token to index.",Lo,Wt,Qr=`<code>tokenizer.get_vocab()[token]</code> is equivalent to <code>tokenizer.convert_tokens_to_ids(token)</code> when <code>token</code> is in the
vocab.`,Co,j,De,Wo,Ut,Yr=`Pad a single encoded input or a batch of encoded inputs up to predefined length or to the max sequence length
in the batch.`,Uo,Jt,Or=`Padding side (left/right) padding token ids are defined at the tokenizer level (with <code>self.padding_side</code>,
<code>self.pad_token_id</code> and <code>self.pad_token_type_id</code>).`,Jo,Ft,Kr=`Please note that with a fast tokenizer, using the <code>__call__</code> method is faster than using a method to encode the
text followed by a call to the <code>pad</code> method to get a padded encoding.`,Fo,me,No,ue,Se,Zo,Nt,ea=`Prepares a sequence of input id, or a pair of sequences of inputs ids so that it can be used by the model. It
...
overflowing tokens. Such a combination of arguments will raise an error.`,Vo,he,Ee,Do,Zt,ta="Prepare model inputs for translation. For best performance, translate one sentence at a time.",So,S,Re,Eo,Vt,na="Upload the tokenizer files to the 🤗 Model Hub.",Ro,fe,Ao,E,Ae,Ho,Dt,oa=`Register this class with a given auto class. This should only be used for custom tokenizers as the ones in the
library are already mapped with <code>AutoTokenizer</code>.`,Go,_e,Xo,W,He,Qo,St,ra="Save the full tokenizer state.",Yo,Et,aa=`This method make sure the full tokenizer can then be re-loaded using the
<code>~tokenization_utils_base.PreTrainedTokenizer.from_pretrained</code> class method..`,Oo,Rt,sa=`Warning,None This won’t save modifications you may have applied to the tokenizer after the instantiation (for
instance, modifying <code>tokenizer.do_lower_case</code> after creation).`,Ko,R,Ge,er,At,ia="Save only the vocabulary of the tokenizer (vocabulary + added tokens).",tr,Ht,da=`This method won’t save the configuration and special token mappings of the tokenizer. Use
<code>_save_pretrained()</code> to save the whole state of the tokenizer.`,nr,ge,Xe,or,Gt,ca="Converts a string into a sequence of tokens, replacing unknown tokens with the <code>unk_token</code>.",rr,ke,Qe,ar,Xt,la="Truncates a sequence pair in-place following the strategy.",wn,Ye,zn,I,Oe,sr,Qt,pa=`A mixin derived by <a href="/docs/transformers/main/ja/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a> and <a href="/docs/transformers/main/ja/main_classes/tokenizer#transformers.PreTrainedTokenizerFast">PreTrainedTokenizerFast</a> to handle specific behaviors related to
special tokens. In particular, this class hold the attributes which can be used to directly access these special
tokens in a model-independent manner and allow to set and update the special tokens.`,ir,M,Ke,dr,Yt,ma=`Add a dictionary of special tokens (eos, pad, cls, etc.) to the encoder and link them to class attributes. If
special tokens are NOT in the vocabulary, they are added to it (indexed starting from the last index of the
current vocabulary).`,cr,Ot,ua=`When adding new tokens to the vocabulary, you should make sure to also resize the token embedding matrix of the
model so that its embedding matrix matches the tokenizer.`,lr,Kt,ha='In order to do that, please use the <a href="/docs/transformers/main/ja/main_classes/model#transformers.PreTrainedModel.resize_token_embeddings">resize_token_embeddings()</a> method.',pr,en,fa="Using <code>add_special_tokens</code> will ensure your special tokens can be used in several ways:",mr,tn,_a=`<li>Special tokens can be skipped when decoding using <code>skip_special_tokens = True</code>.</li> <li>Special tokens are carefully handled by the tokenizer (they are never split), similar to <code>AddedTokens</code>.</li> <li>You can easily refer to special tokens using tokenizer class attributes like <code>tokenizer.cls_token</code>. This
makes it easy to develop model-agnostic training and fine-tuning scripts.</li>`,ur,nn,ga=`When possible, special tokens are already registered for provided pretrained models (for instance
<a href="/docs/transformers/main/ja/model_doc/bert#transformers.BertTokenizer">BertTokenizer</a> <code>cls_token</code> is already registered to be :obj<em>’[CLS]’</em> and XLM’s one is also registered to be
<code>&#39;&lt;/s&gt;&#39;</code>).`,hr,be,fr,L,et,_r,on,ka=`Add a list of new tokens to the tokenizer class. If the new tokens are not in the vocabulary, they are added to
it with indices starting from length of the current vocabulary and and will be isolated before the tokenization
algorithm is applied. Added tokens and tokens from the vocabulary of the tokenization algorithm are therefore
not treated in the same way.`,gr,rn,ba=`Note, when adding new tokens to the vocabulary, you should make sure to also resize the token embedding matrix
of the model so that its embedding matrix matches the tokenizer.`,kr,an,Ta='In order to do that, please use the <a href="/docs/transformers/main/ja/main_classes/model#transformers.PreTrainedModel.resize_token_embeddings">resize_token_embeddings()</a> method.',br,Te,Tr,ve,tt,vr,sn,va=`The <code>sanitize_special_tokens</code> is now deprecated kept for backward compatibility and will be removed in
transformers v5.`,$n,nt,Pn,X,ot,yr,dn,ya=`Possible values for the <code>truncation</code> argument in <a href="/docs/transformers/main/ja/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__">PreTrainedTokenizerBase.<strong>call</strong>()</a>. Useful for tab-completion in
an IDE.`,Bn,Q,rt,xr,cn,xa="Character span in the original string.",Mn,Y,at,wr,ln,wa="Token span in an encoded string (list of tokens).",qn,bn,In;return $=new Dn({props:{title:"Utilities for Tokenizers",local:"utilities-for-tokenizers",headingTag:"h1"}}),ze=new Dn({props:{title:"PreTrainedTokenizerBase",local:"transformers.PreTrainedTokenizerBase",headingTag:"h2"}}),$e=new w({props:{name:"class transformers.PreTrainedTokenizerBase",anchor:"transformers.PreTrainedTokenizerBase",parameters:[{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.PreTrainedTokenizerBase.model_max_length",description:`<strong>model_max_length</strong> (<code>int</code>, <em>optional</em>) &#x2014;
...
<code>&gt;= 7.5</code> (Volta).`,name:"pad_to_multiple_of"},{anchor:"transformers.PreTrainedTokenizerBase.__call__.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/main/ja/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
...
<p><a
  href="/docs/transformers/main/ja/main_classes/tokenizer#transformers.BatchEncoding"
>BatchEncoding</a></p>
`}}),Be=new w({props:{name:"apply_chat_template",anchor:"transformers.PreTrainedTokenizerBase.apply_chat_template",parameters:[{name:"conversation",val:": Union"},{name:"chat_template",val:": Optional = None"},{name:"add_generation_prompt",val:": bool = False"},{name:"tokenize",val:": bool = True"},{name:"padding",val:": bool = False"},{name:"truncation",val:": bool = False"},{name:"max_length",val:": Optional = None"},{name:"return_tensors",val:": Union = None"},{name:"return_dict",val:": bool = False"},{name:"**tokenizer_kwargs",val:""}],parametersDescription:[{anchor:"transformers.PreTrainedTokenizerBase.apply_chat_template.conversation",description:`<strong>conversation</strong> (Union[List[Dict[str, str]], &#x201C;Conversation&#x201D;]) &#x2014; A Conversation object or list of dicts
with &#x201C;role&#x201D; and &#x201C;content&#x201D; keys, representing the chat history so far.`,name:"conversation"},{anchor:"transformers.PreTrainedTokenizerBase.apply_chat_template.chat_template",description:`<strong>chat_template</strong> (str, <em>optional</em>) &#x2014; A Jinja template to use for this conversion. If
this is not passed, the model&#x2019;s default chat template will be used instead.`,name:"chat_template"},{anchor:"transformers.PreTrainedTokenizerBase.apply_chat_template.add_generation_prompt",description:`<strong>add_generation_prompt</strong> (bool, <em>optional</em>) &#x2014; Whether to end the prompt with the token(s) that indicate
the start of an assistant message. This is useful when you want to generate a response from the model.
Note that this argument will be passed to the chat template, and so it must be supported in the
template for this argument to have any effect.`,name:"add_generation_prompt"},{anchor:"transformers.PreTrainedTokenizerBase.apply_chat_template.tokenize",description:`<strong>tokenize</strong> (<code>bool</code>, defaults to <code>True</code>) &#x2014;
...
</ul>`,name:"return_tensors"},{anchor:"transformers.PreTrainedTokenizerBase.apply_chat_template.return_dict",description:`<strong>return_dict</strong> (<code>bool</code>, <em>optional</em>, defaults to <code>False</code>) &#x2014;
...
If set will pad the sequence to a multiple of the provided value. Requires <code>padding</code> to be activated.
This is especially useful to enable the use of Tensor Cores on NVIDIA hardware with compute capability
<code>&gt;= 7.5</code> (Volta).`,name:"pad_to_multiple_of"},{anchor:"transformers.PreTrainedTokenizerBase.batch_encode_plus.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/main/ja/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
If set, will return tensors instead of list of python integers. Acceptable values are:</p>
<ul>
<li><code>&apos;tf&apos;</code>: Return TensorFlow <code>tf.constant</code> objects.</li>
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
...
Whether or not to print more information and warnings.
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/QubitPi/huggingface-transformers/blob/main/src/transformers/tokenization_utils_base.py#L3052",returnDescription:`<script context="module">export const metadata = 'undefined';<\/script>
...
<p><code>str</code></p>
`}}),Ce=new w({props:{name:"convert_tokens_to_string",anchor:"transformers.PreTrainedTokenizerBase.convert_tokens_to_string",parameters:[{name:"tokens",val:": List"}],parametersDescription:[{anchor:"transformers.PreTrainedTokenizerBase.convert_tokens_to_string.tokens",description:"<strong>tokens</strong> (<code>List[str]</code>) &#x2014; The token to join in a string.",name:"tokens"}],source:"https://github.com/QubitPi/huggingface-transformers/blob/main/src/transformers/tokenization_utils_base.py#L3705",returnDescription:`<script context="module">export const metadata = 'undefined';<\/script>
...
If set will pad the sequence to a multiple of the provided value. Requires <code>padding</code> to be activated.
This is especially useful to enable the use of Tensor Cores on NVIDIA hardware with compute capability
<code>&gt;= 7.5</code> (Volta).`,name:"pad_to_multiple_of"},{anchor:"transformers.PreTrainedTokenizerBase.encode.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/main/ja/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
If set, will return tensors instead of list of python integers. Acceptable values are:</p>
<ul>
<li><code>&apos;tf&apos;</code>: Return TensorFlow <code>tf.constant</code> objects.</li>
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
...
If set will pad the sequence to a multiple of the provided value. Requires <code>padding</code> to be activated.
This is especially useful to enable the use of Tensor Cores on NVIDIA hardware with compute capability
<code>&gt;= 7.5</code> (Volta).`,name:"pad_to_multiple_of"},{anchor:"transformers.PreTrainedTokenizerBase.encode_plus.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/main/ja/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
If set, will return tensors instead of list of python integers. Acceptable values are:</p>
<ul>
<li><code>&apos;tf&apos;</code>: Return TensorFlow <code>tf.constant</code> objects.</li>
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
...
Whether or not to print more information and warnings.
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/QubitPi/huggingface-transformers/blob/main/src/transformers/tokenization_utils_base.py#L2956",returnDescription:`<script context="module">export const metadata = 'undefined';<\/script>
...
using the <a href="/docs/transformers/main/ja/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.save_pretrained">save_pretrained()</a> method, e.g.,
...
`}}),Ve=new w({props:{name:"get_vocab",anchor:"transformers.PreTrainedTokenizerBase.get_vocab",parameters:[],source:"https://github.com/QubitPi/huggingface-transformers/blob/main/src/transformers/tokenization_utils_base.py#L1666",returnDescription:`<script context="module">export const metadata = 'undefined';<\/script>
...
`}}),De=new w({props:{name:"pad",anchor:"transformers.PreTrainedTokenizerBase.pad",parameters:[{name:"encoded_inputs",val:": Union"},{name:"padding",val:": Union = True"},{name:"max_length",val:": Optional = None"},{name:"pad_to_multiple_of",val:": Optional = None"},{name:"return_attention_mask",val:": Optional = None"},{name:"return_tensors",val:": Union = None"},{name:"verbose",val:": bool = True"}],parametersDescription:[{anchor:"transformers.PreTrainedTokenizerBase.pad.encoded_inputs",description:`<strong>encoded_inputs</strong> (<a href="/docs/transformers/main/ja/main_classes/tokenizer#transformers.BatchEncoding">BatchEncoding</a>, list of <a href="/docs/transformers/main/ja/main_classes/tokenizer#transformers.BatchEncoding">BatchEncoding</a>, <code>Dict[str, List[int]]</code>, <code>Dict[str, List[List[int]]</code> or <code>List[Dict[str, List[int]]]</code>) &#x2014;
Tokenized inputs. Can represent one input (<a href="/docs/transformers/main/ja/main_classes/tokenizer#transformers.BatchEncoding">BatchEncoding</a> or <code>Dict[str, List[int]]</code>) or a batch of
tokenized inputs (list of <a href="/docs/transformers/main/ja/main_classes/tokenizer#transformers.BatchEncoding">BatchEncoding</a>, <em>Dict[str, List[List[int]]]</em> or <em>List[Dict[str,
...
<code>&gt;= 7.5</code> (Volta).`,name:"pad_to_multiple_of"},{anchor:"transformers.PreTrainedTokenizerBase.pad.return_attention_mask",description:`<strong>return_attention_mask</strong> (<code>bool</code>, <em>optional</em>) &#x2014;
Whether to return the attention mask. If left to the default, will return the attention mask according
to the specific tokenizer&#x2019;s default, defined by the <code>return_outputs</code> attribute.</p>
...
If set will pad the sequence to a multiple of the provided value. Requires <code>padding</code> to be activated.
This is especially useful to enable the use of Tensor Cores on NVIDIA hardware with compute capability
<code>&gt;= 7.5</code> (Volta).`,name:"pad_to_multiple_of"},{anchor:"transformers.PreTrainedTokenizerBase.prepare_for_model.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/main/ja/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
If set, will return tensors instead of list of python integers. Acceptable values are:</p>
<ul>
<li><code>&apos;tf&apos;</code>: Return TensorFlow <code>tf.constant</code> objects.</li>
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
...
Whether or not to print more information and warnings.
**kwargs &#x2014; passed to the <code>self.tokenize()</code> method`,name:"verbose"}],source:"https://github.com/QubitPi/huggingface-transformers/blob/main/src/transformers/tokenization_utils_base.py#L3368",returnDescription:`<script context="module">export const metadata = 'undefined';<\/script>
...
<li><code>False</code> or <code>&apos;do_not_pad&apos;</code> (default): No padding (i.e., can output a batch with sequences of different
lengths).</li>
</ul>`,name:"padding"},{anchor:"transformers.PreTrainedTokenizerBase.prepare_seq2seq_batch.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/main/ja/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
If set, will return tensors instead of list of python integers. Acceptable values are:</p>
<ul>
<li><code>&apos;tf&apos;</code>: Return TensorFlow <code>tf.constant</code> objects.</li>
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
<li><code>&apos;np&apos;</code>: Return Numpy <code>np.ndarray</code> objects.</li>
</ul>`,name:"return_tensors"},{anchor:"transformers.PreTrainedTokenizerBase.prepare_seq2seq_batch.truncation",description:`<strong>truncation</strong> (<code>bool</code>, <code>str</code> or <a href="/docs/transformers/main/ja/internal/tokenization_utils#transformers.tokenization_utils_base.TruncationStrategy">TruncationStrategy</a>, <em>optional</em>, defaults to <code>True</code>) &#x2014;
Activates and controls truncation. Accepts the following values:</p>
<ul>
<li><code>True</code> or <code>&apos;longest_first&apos;</code>: Truncate to a maximum length specified with the argument <code>max_length</code> or
to the maximum acceptable input length for the model if that argument is not provided. This will
...
</ul>`,name:"truncation"}],source:"https://github.com/QubitPi/huggingface-transformers/blob/main/src/transformers/tokenization_utils_base.py#L3929",returnDescription:`<script context="module">export const metadata = 'undefined';<\/script>
...
An optional prefix to add to the named of the saved files.`,name:"filename_prefix"}],source:"https://github.com/QubitPi/huggingface-transformers/blob/main/src/transformers/tokenization_utils_base.py#L2525",returnDescription:`<script context="module">export const metadata = 'undefined';<\/script>
...
<a href="/docs/transformers/main/ja/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__"><strong>call</strong>()</a>`,name:"kwargs"}],source:"https://github.com/QubitPi/huggingface-transformers/blob/main/src/transformers/tokenization_utils_base.py#L2543",returnDescription:`<script context="module">export const metadata = 'undefined';<\/script>
...
sequence returned. The value of this argument defines the number of additional tokens.`,name:"stride"}],source:"https://github.com/QubitPi/huggingface-transformers/blob/main/src/transformers/tokenization_utils_base.py#L3504",returnDescription:`<script context="module">export const metadata = 'undefined';<\/script>
...
`}}),Ye=new Dn({props:{title:"SpecialTokensMixin",local:"transformers.SpecialTokensMixin",headingTag:"h2"}}),Oe=new w({props:{name:"class transformers.SpecialTokensMixin",anchor:"transformers.SpecialTokensMixin",parameters:[{name:"verbose",val:" = False"},{name:"**kwargs",val:""}],parametersDescription:[{anchor:"transformers.SpecialTokensMixin.bos_token",description:`<strong>bos_token</strong> (<code>str</code> or <code>tokenizers.AddedToken</code>, <em>optional</em>) &#x2014;
...
skipped when decoding if <code>skip_special_tokens</code> is set to <code>True</code>.`,name:"additional_special_tokens"}],source:"https://github.com/QubitPi/huggingface-transformers/blob/main/src/transformers/tokenization_utils_base.py#L795"}}),Ke=new w({props:{name:"add_special_tokens",anchor:"transformers.SpecialTokensMixin.add_special_tokens",parameters:[{name:"special_tokens_dict",val:": Dict"},{name:"replace_additional_special_tokens",val:" = True"}],parametersDescription:[{anchor:"transformers.SpecialTokensMixin.add_special_tokens.special_tokens_dict",description:`<strong>special_tokens_dict</strong> (dictionary <em>str</em> to <em>str</em> or <code>tokenizers.AddedToken</code>) &#x2014;
...
<p><code>int</code></p>
`}}),be=new Vn({props:{anchor:"transformers.SpecialTokensMixin.add_special_tokens.example",$$slots:{default:[Ja]},$$scope:{ctx:B}}}),et=new w({props:{name:"add_tokens",anchor:"transformers.SpecialTokensMixin.add_tokens",parameters:[{name:"new_tokens",val:": Union"},{name:"special_tokens",val:": bool = False"}],parametersDescription:[{anchor:"transformers.SpecialTokensMixin.add_tokens.new_tokens",description:`<strong>new_tokens</strong> (<code>str</code>, <code>tokenizers.AddedToken</code> or a list of <em>str</em> or <code>tokenizers.AddedToken</code>) &#x2014;
...
<p><code>int</code></p>
`}}),Te=new Vn({props:{anchor:"transformers.SpecialTokensMixin.add_tokens.example",$$slots:{default:[Fa]},$$scope:{ctx:B}}}),tt=new w({props:{name:"sanitize_special_tokens",anchor:"transformers.SpecialTokensMixin.sanitize_special_tokens",parameters:[],source:"https://github.com/QubitPi/huggingface-transformers/blob/main/src/transformers/tokenization_utils_base.py#L865"}}),nt=new Dn({props:{title:"Enums and namedtuples",local:"transformers.tokenization_utils_base.TruncationStrategy",headingTag:"h2"}}),ot=new w({props:{name:"class transformers.tokenization_utils_base.TruncationStrategy",anchor:"transformers.tokenization_utils_base.TruncationStrategy",parameters:[{name:"value",val:""},{name:"names",val:" = None"},{name:"module",val:" = None"},{name:"qualname",val:" = None"},{name:"type",val:" = None"},{name:"start",val:" = 1"}],source:"https://github.com/QubitPi/huggingface-transformers/blob/main/src/transformers/tokenization_utils_base.py#L138"}}),rt=new w({props:{name:"class transformers.CharSpan",anchor:"transformers.CharSpan",parameters:[{name:"start",val:": int"},{name:"end",val:": int"}],parametersDescription:[{anchor:"transformers.CharSpan.start",description:"<strong>start</strong> (<code>int</code>) &#x2014; Index of the first character in the original string.",name:"start"},{anchor:"transformers.CharSpan.end",description:"<strong>end</strong> (<code>int</code>) &#x2014; Index of the character following the last character in the original string.",name:"end"}],source:"https://github.com/QubitPi/huggingface-transformers/blob/main/src/transformers/tokenization_utils_base.py#L150"}}),at=new w({props:{name:"class transformers.TokenSpan",anchor:"transformers.TokenSpan",parameters:[{name:"start",val:": int"},{name:"end",val:": int"}],parametersDescription:[{anchor:"transformers.TokenSpan.start",description:"<strong>start</strong> (<code>int</code>) &#x2014; Index of the first token in the span.",name:"start"},{anchor:"transformers.TokenSpan.end",description:"<strong>end</strong> (<code>int</code>) &#x2014; Index of the token following the last token in the span.",name:"end"}],source:"https://github.com/QubitPi/huggingface-transformers/blob/main/src/transformers/tokenization_utils_base.py#L163"}}),{c(){s=r("meta"),z=n(),m=r("p"),T=n(),u($.$$.fragment),d=n(),P=r("p"),P.innerHTML=zr,vn=n(),we=r("p"),we.textContent=$r,yn=n(),u(ze.$$.fragment),xn=n(),c=r("div"),u($e.$$.fragment),En=n(),mt=r("p"),mt.innerHTML=Pr,Rn=n(),ut=r("p"),ut.textContent=Br,An=n(),ht=r("p"),ht.textContent=Mr,Hn=n(),ft=r("ul"),ft.innerHTML=qr,Gn=n(),te=r("div"),u(Pe.$$.fragment),Xn=n(),_t=r("p"),_t.textContent=Ir,Qn=n(),ne=r("div"),u(Be.$$.fragment),Yn=n(),gt=r("p"),gt.innerHTML=jr,On=n(),oe=r("div"),u(Me.$$.fragment),Kn=n(),kt=r("p"),kt.textContent=Lr,eo=n(),re=r("div"),u(qe.$$.fragment),to=n(),bt=r("p"),bt.textContent=Cr,no=n(),U=r("div"),u(Ie.$$.fragment),oo=n(),Tt=r("p"),Tt.textContent=Wr,ro=n(),u(ae.$$.fragment),ao=n(),J=r("div"),u(je.$$.fragment),so=n(),vt=r("p"),vt.textContent=Ur,io=n(),yt=r("p"),yt.textContent=Jr,co=n(),se=r("div"),u(Le.$$.fragment),lo=n(),xt=r("p"),xt.textContent=Fr,po=n(),ie=r("div"),u(Ce.$$.fragment),mo=n(),wt=r("p"),wt.innerHTML=Nr,uo=n(),F=r("div"),u(We.$$.fragment),ho=n(),zt=r("p"),zt.innerHTML=Zr,fo=n(),$t=r("p"),$t.textContent=Vr,_o=n(),N=r("div"),u(Ue.$$.fragment),go=n(),Pt=r("p"),Pt.textContent=Dr,ko=n(),Bt=r("p"),Bt.innerHTML=Sr,bo=n(),Z=r("div"),u(Je.$$.fragment),To=n(),Mt=r("p"),Mt.textContent=Er,vo=n(),qt=r("p"),qt.innerHTML=Rr,yo=n(),V=r("div"),u(Fe.$$.fragment),xo=n(),It=r("p"),It.textContent=Ar,wo=n(),u(de.$$.fragment),zo=n(),C=r("div"),u(Ne.$$.fragment),$o=n(),jt=r("p"),jt.innerHTML=Hr,Po=n(),u(ce.$$.fragment),Bo=n(),u(le.$$.fragment),Mo=n(),pe=r("div"),u(Ze.$$.fragment),qo=n(),Lt=r("p"),Lt.innerHTML=Gr,Io=n(),D=r("div"),u(Ve.$$.fragment),jo=n(),Ct=r("p"),Ct.textContent=Xr,Lo=n(),Wt=r("p"),Wt.innerHTML=Qr,Co=n(),j=r("div"),u(De.$$.fragment),Wo=n(),Ut=r("p"),Ut.textContent=Yr,Uo=n(),Jt=r("p"),Jt.innerHTML=Or,Jo=n(),Ft=r("p"),Ft.innerHTML=Kr,Fo=n(),u(me.$$.fragment),No=n(),ue=r("div"),u(Se.$$.fragment),Zo=n(),Nt=r("p"),Nt.innerHTML=ea,Vo=n(),he=r("div"),u(Ee.$$.fragment),Do=n(),Zt=r("p"),Zt.textContent=ta,So=n(),S=r("div"),u(Re.$$.fragment),Eo=n(),Vt=r("p"),Vt.textContent=na,Ro=n(),u(fe.$$.fragment),Ao=n(),E=r("div"),u(Ae.$$.fragment),Ho=n(),Dt=r("p"),Dt.innerHTML=oa,Go=n(),u(_e.$$.fragment),Xo=n(),W=r("div"),u(He.$$.fragment),Qo=n(),St=r("p"),St.textContent=ra,Yo=n(),Et=r("p"),Et.innerHTML=aa,Oo=n(),Rt=r("p"),Rt.innerHTML=sa,Ko=n(),R=r("div"),u(Ge.$$.fragment),er=n(),At=r("p"),At.textContent=ia,tr=n(),Ht=r("p"),Ht.innerHTML=da,nr=n(),ge=r("div"),u(Xe.$$.fragment),or=n(),Gt=r("p"),Gt.innerHTML=ca,rr=n(),ke=r("div"),u(Qe.$$.fragment),ar=n(),Xt=r("p"),Xt.textContent=la,wn=n(),u(Ye.$$.fragment),zn=n(),I=r("div"),u(Oe.$$.fragment),sr=n(),Qt=r("p"),Qt.innerHTML=pa,ir=n(),M=r("div"),u(Ke.$$.fragment),dr=n(),Yt=r("p"),Yt.textContent=ma,cr=n(),Ot=r("p"),Ot.textContent=ua,lr=n(),Kt=r("p"),Kt.innerHTML=ha,pr=n(),en=r("p"),en.innerHTML=fa,mr=n(),tn=r("ul"),tn.innerHTML=_a,ur=n(),nn=r("p"),nn.innerHTML=ga,hr=n(),u(be.$$.fragment),fr=n(),L=r("div"),u(et.$$.fragment),_r=n(),on=r("p"),on.textContent=ka,gr=n(),rn=r("p"),rn.textContent=ba,kr=n(),an=r("p"),an.innerHTML=Ta,br=n(),u(Te.$$.fragment),Tr=n(),ve=r("div"),u(tt.$$.fragment),vr=n(),sn=r("p"),sn.innerHTML=va,$n=n(),u(nt.$$.fragment),Pn=n(),X=r("div"),u(ot.$$.fragment),yr=n(),dn=r("p"),dn.innerHTML=ya,Bn=n(),Q=r("div"),u(rt.$$.fragment),xr=n(),cn=r("p"),cn.textContent=xa,Mn=n(),Y=r("div"),u(at.$$.fragment),wr=n(),ln=r("p"),ln.textContent=wa,qn=n(),bn=r("p"),this.h()},l(t){const b=Ma("svelte-u9bgzb",document.head);s=a(b,"META",{name:!0,content:!0}),b.forEach(i),z=o(t),m=a(t,"P",{}),y(m).forEach(i),T=o(t),h($.$$.fragment,t),d=o(t),P=a(t,"P",{"data-svelte-h":!0}),l(P)!=="svelte-101g093"&&(P.innerHTML=zr),vn=o(t),we=a(t,"P",{"data-svelte-h":!0}),l(we)!=="svelte-1erjs9a"&&(we.textContent=$r),yn=o(t),h(ze.$$.fragment,t),xn=o(t),c=a(t,"DIV",{class:!0});var p=y(c);h($e.$$.fragment,p),En=o(p),mt=a(p,"P",{"data-svelte-h":!0}),l(mt)!=="svelte-1opccff"&&(mt.innerHTML=Pr),Rn=o(p),ut=a(p,"P",{"data-svelte-h":!0}),l(ut)!=="svelte-2oj7z8"&&(ut.textContent=Br),An=o(p),ht=a(p,"P",{"data-svelte-h":!0}),l(ht)!=="svelte-1ixo79u"&&(ht.textContent=Mr),Hn=o(p),ft=a(p,"UL",{"data-svelte-h":!0}),l(ft)!=="svelte-10vk6le"&&(ft.innerHTML=qr),Gn=o(p),te=a(p,"DIV",{class:!0});var st=y(te);h(Pe.$$.fragment,st),Xn=o(st),_t=a(st,"P",{"data-svelte-h":!0}),l(_t)!=="svelte-kpxj0c"&&(_t.textContent=Ir),st.forEach(i),Qn=o(p),ne=a(p,"DIV",{class:!0});var it=y(ne);h(Be.$$.fragment,it),Yn=o(it),gt=a(it,"P",{"data-svelte-h":!0}),l(gt)!=="svelte-wjbfy4"&&(gt.innerHTML=jr),it.forEach(i),On=o(p),oe=a(p,"DIV",{class:!0});var dt=y(oe);h(Me.$$.fragment,dt),Kn=o(dt),kt=a(dt,"P",{"data-svelte-h":!0}),l(kt)!=="svelte-hxrl9"&&(kt.textContent=Lr),dt.forEach(i),eo=o(p),re=a(p,"DIV",{class:!0});var ct=y(re);h(qe.$$.fragment,ct),to=o(ct),bt=a(ct,"P",{"data-svelte-h":!0}),l(bt)!=="svelte-1deng2j"&&(bt.textContent=Cr),ct.forEach(i),no=o(p),U=a(p,"DIV",{class:!0});var O=y(U);h(Ie.$$.fragment,O),oo=o(O),Tt=a(O,"P",{"data-svelte-h":!0}),l(Tt)!=="svelte-6p21pf"&&(Tt.textContent=Wr),ro=o(O),h(ae.$$.fragment,O),O.forEach(i),ao=o(p),J=a(p,"DIV",{class:!0});var K=y(J);h(je.$$.fragment,K),so=o(K),vt=a(K,"P",{"data-svelte-h":!0}),l(vt)!=="svelte-xip562"&&(vt.textContent=Ur),io=o(K),yt=a(K,"P",{"data-svelte-h":!0}),l(yt)!=="svelte-1yvfiyo"&&(yt.textContent=Jr),K.forEach(i),co=o(p),se=a(p,"DIV",{class:!0});var lt=y(se);h(Le.$$.fragment,lt),lo=o(lt),xt=a(lt,"P",{"data-svelte-h":!0}),l(xt)!=="svelte-6a62nd"&&(xt.textContent=Fr),lt.forEach(i),po=o(p),ie=a(p,"DIV",{class:!0});var pt=y(ie);h(Ce.$$.fragment,pt),mo=o(pt),wt=a(pt,"P",{"data-svelte-h":!0}),l(wt)!=="svelte-sfkaj8"&&(wt.innerHTML=Nr),pt.forEach(i),uo=o(p),F=a(p,"DIV",{class:!0});var pn=y(F);h(We.$$.fragment,pn),ho=o(pn),zt=a(pn,"P",{"data-svelte-h":!0}),l(zt)!=="svelte-zj1vf1"&&(zt.innerHTML=Zr),fo=o(pn),$t=a(pn,"P",{"data-svelte-h":!0}),l($t)!=="svelte-9vptpw"&&($t.textContent=Vr),pn.forEach(i),_o=o(p),N=a(p,"DIV",{class:!0});var mn=y(N);h(Ue.$$.fragment,mn),go=o(mn),Pt=a(mn,"P",{"data-svelte-h":!0}),l(Pt)!=="svelte-vbfkpu"&&(Pt.textContent=Dr),ko=o(mn),Bt=a(mn,"P",{"data-svelte-h":!0}),l(Bt)!=="svelte-125uxon"&&(Bt.innerHTML=Sr),mn.forEach(i),bo=o(p),Z=a(p,"DIV",{class:!0});var un=y(Z);h(Je.$$.fragment,un),To=o(un),Mt=a(un,"P",{"data-svelte-h":!0}),l(Mt)!=="svelte-12b8hzo"&&(Mt.textContent=Er),vo=o(un),qt=a(un,"P",{"data-svelte-h":!0}),l(qt)!=="svelte-1kyhveh"&&(qt.innerHTML=Rr),un.forEach(i),yo=o(p),V=a(p,"DIV",{class:!0});var hn=y(V);h(Fe.$$.fragment,hn),xo=o(hn),It=a(hn,"P",{"data-svelte-h":!0}),l(It)!=="svelte-ma945j"&&(It.textContent=Ar),wo=o(hn),h(de.$$.fragment,hn),hn.forEach(i),zo=o(p),C=a(p,"DIV",{class:!0});var ye=y(C);h(Ne.$$.fragment,ye),$o=o(ye),jt=a(ye,"P",{"data-svelte-h":!0}),l(jt)!=="svelte-10sncs4"&&(jt.innerHTML=Hr),Po=o(ye),h(ce.$$.fragment,ye),Bo=o(ye),h(le.$$.fragment,ye),ye.forEach(i),Mo=o(p),pe=a(p,"DIV",{class:!0});var jn=y(pe);h(Ze.$$.fragment,jn),qo=o(jn),Lt=a(jn,"P",{"data-svelte-h":!0}),l(Lt)!=="svelte-1wmjg8a"&&(Lt.innerHTML=Gr),jn.forEach(i),Io=o(p),D=a(p,"DIV",{class:!0});var fn=y(D);h(Ve.$$.fragment,fn),jo=o(fn),Ct=a(fn,"P",{"data-svelte-h":!0}),l(Ct)!=="svelte-1gbatu6"&&(Ct.textContent=Xr),Lo=o(fn),Wt=a(fn,"P",{"data-svelte-h":!0}),l(Wt)!=="svelte-907bv"&&(Wt.innerHTML=Qr),fn.forEach(i),Co=o(p),j=a(p,"DIV",{class:!0});var A=y(j);h(De.$$.fragment,A),Wo=o(A),Ut=a(A,"P",{"data-svelte-h":!0}),l(Ut)!=="svelte-1n892mi"&&(Ut.textContent=Yr),Uo=o(A),Jt=a(A,"P",{"data-svelte-h":!0}),l(Jt)!=="svelte-1xir9yc"&&(Jt.innerHTML=Or),Jo=o(A),Ft=a(A,"P",{"data-svelte-h":!0}),l(Ft)!=="svelte-28v9x1"&&(Ft.innerHTML=Kr),Fo=o(A),h(me.$$.fragment,A),A.forEach(i),No=o(p),ue=a(p,"DIV",{class:!0});var Ln=y(ue);h(Se.$$.fragment,Ln),Zo=o(Ln),Nt=a(Ln,"P",{"data-svelte-h":!0}),l(Nt)!=="svelte-cwdwvn"&&(Nt.innerHTML=ea),Ln.forEach(i),Vo=o(p),he=a(p,"DIV",{class:!0});var Cn=y(he);h(Ee.$$.fragment,Cn),Do=o(Cn),Zt=a(Cn,"P",{"data-svelte-h":!0}),l(Zt)!=="svelte-dtuae6"&&(Zt.textContent=ta),Cn.forEach(i),So=o(p),S=a(p,"DIV",{class:!0});var _n=y(S);h(Re.$$.fragment,_n),Eo=o(_n),Vt=a(_n,"P",{"data-svelte-h":!0}),l(Vt)!=="svelte-tpmkl3"&&(Vt.textContent=na),Ro=o(_n),h(fe.$$.fragment,_n),_n.forEach(i),Ao=o(p),E=a(p,"DIV",{class:!0});var gn=y(E);h(Ae.$$.fragment,gn),Ho=o(gn),Dt=a(gn,"P",{"data-svelte-h":!0}),l(Dt)!=="svelte-189h5u2"&&(Dt.innerHTML=oa),Go=o(gn),h(_e.$$.fragment,gn),gn.forEach(i),Xo=o(p),W=a(p,"DIV",{class:!0});var xe=y(W);h(He.$$.fragment,xe),Qo=o(xe),St=a(xe,"P",{"data-svelte-h":!0}),l(St)!=="svelte-u73u19"&&(St.textContent=ra),Yo=o(xe),Et=a(xe,"P",{"data-svelte-h":!0}),l(Et)!=="svelte-p0dt88"&&(Et.innerHTML=aa),Oo=o(xe),Rt=a(xe,"P",{"data-svelte-h":!0}),l(Rt)!=="svelte-1qee1z"&&(Rt.innerHTML=sa),xe.forEach(i),Ko=o(p),R=a(p,"DIV",{class:!0});var kn=y(R);h(Ge.$$.fragment,kn),er=o(kn),At=a(kn,"P",{"data-svelte-h":!0}),l(At)!=="svelte-rx0wq1"&&(At.textContent=ia),tr=o(kn),Ht=a(kn,"P",{"data-svelte-h":!0}),l(Ht)!=="svelte-c9295b"&&(Ht.innerHTML=da),kn.forEach(i),nr=o(p),ge=a(p,"DIV",{class:!0});var Wn=y(ge);h(Xe.$$.fragment,Wn),or=o(Wn),Gt=a(Wn,"P",{"data-svelte-h":!0}),l(Gt)!=="svelte-ikoqgw"&&(Gt.innerHTML=ca),Wn.forEach(i),rr=o(p),ke=a(p,"DIV",{class:!0});var Un=y(ke);h(Qe.$$.fragment,Un),ar=o(Un),Xt=a(Un,"P",{"data-svelte-h":!0}),l(Xt)!=="svelte-fkofn"&&(Xt.textContent=la),Un.forEach(i),p.forEach(i),wn=o(t),h(Ye.$$.fragment,t),zn=o(t),I=a(t,"DIV",{class:!0});var H=y(I);h(Oe.$$.fragment,H),sr=o(H),Qt=a(H,"P",{"data-svelte-h":!0}),l(Qt)!=="svelte-189ta4n"&&(Qt.innerHTML=pa),ir=o(H),M=a(H,"DIV",{class:!0});var q=y(M);h(Ke.$$.fragment,q),dr=o(q),Yt=a(q,"P",{"data-svelte-h":!0}),l(Yt)!=="svelte-1j8s0i5"&&(Yt.textContent=ma),cr=o(q),Ot=a(q,"P",{"data-svelte-h":!0}),l(Ot)!=="svelte-1w3ayx9"&&(Ot.textContent=ua),lr=o(q),Kt=a(q,"P",{"data-svelte-h":!0}),l(Kt)!=="svelte-1k3j6ir"&&(Kt.innerHTML=ha),pr=o(q),en=a(q,"P",{"data-svelte-h":!0}),l(en)!=="svelte-5hxtpc"&&(en.innerHTML=fa),mr=o(q),tn=a(q,"UL",{"data-svelte-h":!0}),l(tn)!=="svelte-1pes0uj"&&(tn.innerHTML=_a),ur=o(q),nn=a(q,"P",{"data-svelte-h":!0}),l(nn)!=="svelte-1qsyw45"&&(nn.innerHTML=ga),hr=o(q),h(be.$$.fragment,q),q.forEach(i),fr=o(H),L=a(H,"DIV",{class:!0});var G=y(L);h(et.$$.fragment,G),_r=o(G),on=a(G,"P",{"data-svelte-h":!0}),l(on)!=="svelte-14rotd7"&&(on.textContent=ka),gr=o(G),rn=a(G,"P",{"data-svelte-h":!0}),l(rn)!=="svelte-j0w5r1"&&(rn.textContent=ba),kr=o(G),an=a(G,"P",{"data-svelte-h":!0}),l(an)!=="svelte-1k3j6ir"&&(an.innerHTML=Ta),br=o(G),h(Te.$$.fragment,G),G.forEach(i),Tr=o(H),ve=a(H,"DIV",{class:!0});var Jn=y(ve);h(tt.$$.fragment,Jn),vr=o(Jn),sn=a(Jn,"P",{"data-svelte-h":!0}),l(sn)!=="svelte-1em0285"&&(sn.innerHTML=va),Jn.forEach(i),H.forEach(i),$n=o(t),h(nt.$$.fragment,t),Pn=o(t),X=a(t,"DIV",{class:!0});var Fn=y(X);h(ot.$$.fragment,Fn),yr=o(Fn),dn=a(Fn,"P",{"data-svelte-h":!0}),l(dn)!=="svelte-796an9"&&(dn.innerHTML=ya),Fn.forEach(i),Bn=o(t),Q=a(t,"DIV",{class:!0});var Nn=y(Q);h(rt.$$.fragment,Nn),xr=o(Nn),cn=a(Nn,"P",{"data-svelte-h":!0}),l(cn)!=="svelte-136gduh"&&(cn.textContent=xa),Nn.forEach(i),Mn=o(t),Y=a(t,"DIV",{class:!0});var Zn=y(Y);h(at.$$.fragment,Zn),wr=o(Zn),ln=a(Zn,"P",{"data-svelte-h":!0}),l(ln)!=="svelte-18ocfae"&&(ln.textContent=wa),Zn.forEach(i),qn=o(t),bn=a(t,"P",{}),y(bn).forEach(i),this.h()},h(){x(s,"name","hf:doc:metadata"),x(s,"content",Za),x(te,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),x(ne,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),x(oe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),x(re,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),x(U,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),x(J,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),x(se,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),x(ie,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),x(F,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),x(N,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),x(Z,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),x(V,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),x(C,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),x(pe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),x(D,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),x(j,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),x(ue,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),x(he,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),x(S,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),x(E,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),x(W,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),x(R,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),x(ge,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),x(ke,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),x(c,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),x(M,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),x(L,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),x(ve,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),x(I,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),x(X,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),x(Q,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),x(Y,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(t,b){e(document.head,s),v(t,z,b),v(t,m,b),v(t,T,b),f($,t,b),v(t,d,b),v(t,P,b),v(t,vn,b),v(t,we,b),v(t,yn,b),f(ze,t,b),v(t,xn,b),v(t,c,b),f($e,c,null),e(c,En),e(c,mt),e(c,Rn),e(c,ut),e(c,An),e(c,ht),e(c,Hn),e(c,ft),e(c,Gn),e(c,te),f(Pe,te,null),e(te,Xn),e(te,_t),e(c,Qn),e(c,ne),f(Be,ne,null),e(ne,Yn),e(ne,gt),e(c,On),e(c,oe),f(Me,oe,null),e(oe,Kn),e(oe,kt),e(c,eo),e(c,re),f(qe,re,null),e(re,to),e(re,bt),e(c,no),e(c,U),f(Ie,U,null),e(U,oo),e(U,Tt),e(U,ro),f(ae,U,null),e(c,ao),e(c,J),f(je,J,null),e(J,so),e(J,vt),e(J,io),e(J,yt),e(c,co),e(c,se),f(Le,se,null),e(se,lo),e(se,xt),e(c,po),e(c,ie),f(Ce,ie,null),e(ie,mo),e(ie,wt),e(c,uo),e(c,F),f(We,F,null),e(F,ho),e(F,zt),e(F,fo),e(F,$t),e(c,_o),e(c,N),f(Ue,N,null),e(N,go),e(N,Pt),e(N,ko),e(N,Bt),e(c,bo),e(c,Z),f(Je,Z,null),e(Z,To),e(Z,Mt),e(Z,vo),e(Z,qt),e(c,yo),e(c,V),f(Fe,V,null),e(V,xo),e(V,It),e(V,wo),f(de,V,null),e(c,zo),e(c,C),f(Ne,C,null),e(C,$o),e(C,jt),e(C,Po),f(ce,C,null),e(C,Bo),f(le,C,null),e(c,Mo),e(c,pe),f(Ze,pe,null),e(pe,qo),e(pe,Lt),e(c,Io),e(c,D),f(Ve,D,null),e(D,jo),e(D,Ct),e(D,Lo),e(D,Wt),e(c,Co),e(c,j),f(De,j,null),e(j,Wo),e(j,Ut),e(j,Uo),e(j,Jt),e(j,Jo),e(j,Ft),e(j,Fo),f(me,j,null),e(c,No),e(c,ue),f(Se,ue,null),e(ue,Zo),e(ue,Nt),e(c,Vo),e(c,he),f(Ee,he,null),e(he,Do),e(he,Zt),e(c,So),e(c,S),f(Re,S,null),e(S,Eo),e(S,Vt),e(S,Ro),f(fe,S,null),e(c,Ao),e(c,E),f(Ae,E,null),e(E,Ho),e(E,Dt),e(E,Go),f(_e,E,null),e(c,Xo),e(c,W),f(He,W,null),e(W,Qo),e(W,St),e(W,Yo),e(W,Et),e(W,Oo),e(W,Rt),e(c,Ko),e(c,R),f(Ge,R,null),e(R,er),e(R,At),e(R,tr),e(R,Ht),e(c,nr),e(c,ge),f(Xe,ge,null),e(ge,or),e(ge,Gt),e(c,rr),e(c,ke),f(Qe,ke,null),e(ke,ar),e(ke,Xt),v(t,wn,b),f(Ye,t,b),v(t,zn,b),v(t,I,b),f(Oe,I,null),e(I,sr),e(I,Qt),e(I,ir),e(I,M),f(Ke,M,null),e(M,dr),e(M,Yt),e(M,cr),e(M,Ot),e(M,lr),e(M,Kt),e(M,pr),e(M,en),e(M,mr),e(M,tn),e(M,ur),e(M,nn),e(M,hr),f(be,M,null),e(I,fr),e(I,L),f(et,L,null),e(L,_r),e(L,on),e(L,gr),e(L,rn),e(L,kr),e(L,an),e(L,br),f(Te,L,null),e(I,Tr),e(I,ve),f(tt,ve,null),e(ve,vr),e(ve,sn),v(t,$n,b),f(nt,t,b),v(t,Pn,b),v(t,X,b),f(ot,X,null),e(X,yr),e(X,dn),v(t,Bn,b),v(t,Q,b),f(rt,Q,null),e(Q,xr),e(Q,cn),v(t,Mn,b),v(t,Y,b),f(at,Y,null),e(Y,wr),e(Y,ln),v(t,qn,b),v(t,bn,b),In=!0},p(t,[b]){const p={};b&2&&(p.$$scope={dirty:b,ctx:t}),ae.$set(p);const st={};b&2&&(st.$$scope={dirty:b,ctx:t}),de.$set(st);const it={};b&2&&(it.$$scope={dirty:b,ctx:t}),ce.$set(it);const dt={};b&2&&(dt.$$scope={dirty:b,ctx:t}),le.$set(dt);const ct={};b&2&&(ct.$$scope={dirty:b,ctx:t}),me.$set(ct);const O={};b&2&&(O.$$scope={dirty:b,ctx:t}),fe.$set(O);const K={};b&2&&(K.$$scope={dirty:b,ctx:t}),_e.$set(K);const lt={};b&2&&(lt.$$scope={dirty:b,ctx:t}),be.$set(lt);const pt={};b&2&&(pt.$$scope={dirty:b,ctx:t}),Te.$set(pt)},i(t){In||(_($.$$.fragment,t),_(ze.$$.fragment,t),_($e.$$.fragment,t),_(Pe.$$.fragment,t),_(Be.$$.fragment,t),_(Me.$$.fragment,t),_(qe.$$.fragment,t),_(Ie.$$.fragment,t),_(ae.$$.fragment,t),_(je.$$.fragment,t),_(Le.$$.fragment,t),_(Ce.$$.fragment,t),_(We.$$.fragment,t),_(Ue.$$.fragment,t),_(Je.$$.fragment,t),_(Fe.$$.fragment,t),_(de.$$.fragment,t),_(Ne.$$.fragment,t),_(ce.$$.fragment,t),_(le.$$.fragment,t),_(Ze.$$.fragment,t),_(Ve.$$.fragment,t),_(De.$$.fragment,t),_(me.$$.fragment,t),_(Se.$$.fragment,t),_(Ee.$$.fragment,t),_(Re.$$.fragment,t),_(fe.$$.fragment,t),_(Ae.$$.fragment,t),_(_e.$$.fragment,t),_(He.$$.fragment,t),_(Ge.$$.fragment,t),_(Xe.$$.fragment,t),_(Qe.$$.fragment,t),_(Ye.$$.fragment,t),_(Oe.$$.fragment,t),_(Ke.$$.fragment,t),_(be.$$.fragment,t),_(et.$$.fragment,t),_(Te.$$.fragment,t),_(tt.$$.fragment,t),_(nt.$$.fragment,t),_(ot.$$.fragment,t),_(rt.$$.fragment,t),_(at.$$.fragment,t),In=!0)},o(t){g($.$$.fragment,t),g(ze.$$.fragment,t),g($e.$$.fragment,t),g(Pe.$$.fragment,t),g(Be.$$.fragment,t),g(Me.$$.fragment,t),g(qe.$$.fragment,t),g(Ie.$$.fragment,t),g(ae.$$.fragment,t),g(je.$$.fragment,t),g(Le.$$.fragment,t),g(Ce.$$.fragment,t),g(We.$$.fragment,t),g(Ue.$$.fragment,t),g(Je.$$.fragment,t),g(Fe.$$.fragment,t),g(de.$$.fragment,t),g(Ne.$$.fragment,t),g(ce.$$.fragment,t),g(le.$$.fragment,t),g(Ze.$$.fragment,t),g(Ve.$$.fragment,t),g(De.$$.fragment,t),g(me.$$.fragment,t),g(Se.$$.fragment,t),g(Ee.$$.fragment,t),g(Re.$$.fragment,t),g(fe.$$.fragment,t),g(Ae.$$.fragment,t),g(_e.$$.fragment,t),g(He.$$.fragment,t),g(Ge.$$.fragment,t),g(Xe.$$.fragment,t),g(Qe.$$.fragment,t),g(Ye.$$.fragment,t),g(Oe.$$.fragment,t),g(Ke.$$.fragment,t),g(be.$$.fragment,t),g(et.$$.fragment,t),g(Te.$$.fragment,t),g(tt.$$.fragment,t),g(nt.$$.fragment,t),g(ot.$$.fragment,t),g(rt.$$.fragment,t),g(at.$$.fragment,t),In=!1},d(t){t&&(i(z),i(m),i(T),i(d),i(P),i(vn),i(we),i(yn),i(xn),i(c),i(wn),i(zn),i(I),i($n),i(Pn),i(X),i(Bn),i(Q),i(Mn),i(Y),i(qn),i(bn)),i(s),k($,t),k(ze,t),k($e),k(Pe),k(Be),k(Me),k(qe),k(Ie),k(ae),k(je),k(Le),k(Ce),k(We),k(Ue),k(Je),k(Fe),k(de),k(Ne),k(ce),k(le),k(Ze),k(Ve),k(De),k(me),k(Se),k(Ee),k(Re),k(fe),k(Ae),k(_e),k(He),k(Ge),k(Xe),k(Qe),k(Ye,t),k(Oe),k(Ke),k(be),k(et),k(Te),k(tt),k(nt,t),k(ot),k(rt),k(at)}}}const Za='{"title":"Utilities for Tokenizers","local":"utilities-for-tokenizers","sections":[{"title":"PreTrainedTokenizerBase","local":"transformers.PreTrainedTokenizerBase","sections":[],"depth":2},{"title":"SpecialTokensMixin","local":"transformers.SpecialTokensMixin","sections":[],"depth":2},{"title":"Enums and namedtuples","local":"transformers.tokenization_utils_base.TruncationStrategy","sections":[],"depth":2}],"depth":1}';function Va(B){return $a(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Xa extends Pa{constructor(s){super(),Ba(this,s,Va,Na,za,{})}}export{Xa as component};
