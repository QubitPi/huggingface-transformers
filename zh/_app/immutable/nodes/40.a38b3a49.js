import{s as xc,o as Tc,n as Ee}from"../chunks/scheduler.9991993c.js";import{S as vc,i as yc,g as r,s as n,r as l,A as wc,h as s,f as d,c as o,j as T,u as p,x as a,k as v,y as e,a as $,v as m,d as h,t as u,w as f}from"../chunks/index.7fc9a5e7.js";import{T as bc}from"../chunks/Tip.9de92fc6.js";import{D as w}from"../chunks/Docstring.8180f571.js";import{C as Yo}from"../chunks/CodeBlock.e11cba92.js";import{E as Qo}from"../chunks/ExampleCodeBlock.a03fccd6.js";import{H as Cr}from"../chunks/Heading.e3de321f.js";function zc(W){let c,I="Examples:",k,_,P;return _=new Yo({props:{code:"",highlighted:`<span class="hljs-comment"># Let&#x27;s see how to increase the vocabulary of Bert model and tokenizer</span>
...
this inside your training loop.`;return{c(){c=r("p"),c.textContent=I},l(k){c=s(k,"P",{"data-svelte-h":!0}),a(c)!=="svelte-1yi8eve"&&(c.textContent=I)},m(k,_){$(k,c,_)},p:Ee,d(k){k&&d(c)}}}function Lc(W){let c,I,k,_,P,i,M,ki='tokenizer负责准备输入以供模型使用。该库包含所有模型的tokenizer。大多数tokenizer都有两种版本：一个是完全的 Python 实现，另一个是基于 Rust 库 <a href="https://github.com/huggingface/tokenizers" rel="nofollow">🤗 Tokenizers</a> 的“Fast”实现。“Fast” 实现允许：',Ko,Ze,bi="<li>在批量分词时显著提速</li> <li>在原始字符串（字符和单词）和token空间之间进行映射的其他方法（例如，获取包含给定字符的token的索引或与给定token对应的字符范围）。</li>",er,De,xi='基类 [PreTrainedTokenizer] 和 [PreTrained TokenizerFast] 实现了在模型输入中编码字符串输入的常用方法（见下文），并从本地文件或目录或从库提供的预训练的 tokenizer（从 HuggingFace 的 AWS S3 存储库下载）实例化/保存 python 和“Fast” tokenizer。它们都依赖于包含常用方法的 <a href="/docs/transformers/main/zh/internal/tokenization_utils#transformers.PreTrainedTokenizerBase">PreTrainedTokenizerBase</a>和<a href="/docs/transformers/main/zh/internal/tokenization_utils#transformers.SpecialTokensMixin">SpecialTokensMixin</a>。',tr,He,Ti='因此，<a href="/docs/transformers/main/zh/main_classes/tokenizer#transformers.PreTrainedTokenizer">PreTrainedTokenizer</a> 和 <a href="/docs/transformers/main/zh/main_classes/tokenizer#transformers.PreTrainedTokenizerFast">PreTrainedTokenizerFast</a> 实现了使用所有tokenizers的主要方法：',nr,Ge,vi="<li>分词（将字符串拆分为子词标记字符串），将tokens字符串转换为id并转换回来，以及编码/解码（即标记化并转换为整数）。</li> <li>以独立于底层结构（BPE、SentencePiece……）的方式向词汇表中添加新tokens。</li> <li>管理特殊tokens（如mask、句首等）：添加它们，将它们分配给tokenizer中的属性以便于访问，并确保它们在标记过程中不会被分割。</li>",or,Re,yi='<a href="/docs/transformers/main/zh/main_classes/tokenizer#transformers.BatchEncoding">BatchEncoding</a> 包含 <a href="/docs/transformers/main/zh/internal/tokenization_utils#transformers.PreTrainedTokenizerBase">PreTrainedTokenizerBase</a> 的编码方法（<code>__call__</code>、<code>encode_plus</code> 和 <code>batch_encode_plus</code>）的输出，并且是从 Python 字典派生的。当tokenizer是纯 Python tokenizer时，此类的行为就像标准的 Python 字典一样，并保存这些方法计算的各种模型输入（<code>input_ids</code>、<code>attention_mask</code> 等）。当分词器是“Fast”分词器时（即由 HuggingFace 的 <a href="https://github.com/huggingface/tokenizers" rel="nofollow">tokenizers 库</a> 支持），此类还提供了几种高级对齐方法，可用于在原始字符串（字符和单词）与token空间之间进行映射（例如，获取包含给定字符的token的索引或与给定token对应的字符范围）。',rr,Ae,sr,b,Se,qr,Ht,wi="Base class for all slow tokenizers.",Mr,Gt,zi='Inherits from <a href="/docs/transformers/main/zh/internal/tokenization_utils#transformers.PreTrainedTokenizerBase">PreTrainedTokenizerBase</a>.',Ir,Rt,$i=`Handle all the shared methods for tokenization and special tokens as well as methods downloading/caching/loading
pretrained tokenizers as well as adding tokens to the vocabulary.`,Fr,At,Pi=`This class also contain the added tokens in a unified way on top of all tokenizers so we don’t have to handle the
...
something we should change.`,fs,K,at,_s,gn,Qi="Returns the number of added tokens when encoding a sequence with special tokens.",gs,we,ks,ee,it,bs,kn,Yi="Performs any necessary transformations before tokenization.",xs,bn,Oi=`This method should pop the arguments from kwargs and return the remaining <code>kwargs</code> as well. We test the
<code>kwargs</code> at the end of the encoding process to be sure all the arguments have been used.`,Ts,te,dt,vs,xn,Ki="Converts a string into a sequence of tokens, using the tokenizer.",ys,Tn,ed=`Split in words for word-based vocabulary or sub-words for sub-word-based vocabularies
(BPE/SentencePieces/WordPieces). Takes care of added tokens.`,ar,ct,ir,lt,td='<a href="/docs/transformers/main/zh/main_classes/tokenizer#transformers.PreTrainedTokenizerFast">PreTrainedTokenizerFast</a> 依赖于 <a href="https://huggingface.co/docs/tokenizers" rel="nofollow">tokenizers</a> 库。可以非常简单地将从 🤗 tokenizers 库获取的tokenizers加载到 🤗 transformers 中。查看 <a href="../fast_tokenizers">使用 🤗 tokenizers 的分词器</a> 页面以了解如何执行此操作。',dr,x,pt,ws,vn,nd="Base class for all fast tokenizers (wrapping HuggingFace tokenizers library).",zs,yn,od='Inherits from <a href="/docs/transformers/main/zh/internal/tokenization_utils#transformers.PreTrainedTokenizerBase">PreTrainedTokenizerBase</a>.',$s,wn,rd=`Handles all the shared methods for tokenization and special tokens, as well as methods for
...
of the model so that its embedding matrix matches the tokenizer.`,Ws,In,pd='In order to do that, please use the <a href="/docs/transformers/main/zh/main_classes/model#transformers.PreTrainedModel.resize_token_embeddings">resize_token_embeddings()</a> method.',Js,$e,Us,L,ut,Bs,Fn,md=`Add a dictionary of special tokens (eos, pad, cls, etc.) to the encoder and link them to class attributes. If
special tokens are NOT in the vocabulary, they are added to it (indexed starting from the last index of the
...
<code>BertTokenizer</code> <code>cls_token</code> is already registered to be :obj<em>’[CLS]’</em> and XLM’s one is also registered to be
<code>&#39;&lt;/s&gt;&#39;</code>).`,Hs,Pe,Gs,Ce,ft,Rs,Bn,kd=`Converts a Conversation object or a list of dictionaries with <code>&quot;role&quot;</code> and <code>&quot;content&quot;</code> keys to a list of token
ids. This method is intended for use with chat models, and will read the tokenizer’s chat_template attribute to
determine the format and control tokens to use when converting. When chat_template is None, it will fall back
to the default_chat_template specified at the class level.`,As,qe,_t,Ss,Vn,bd="Convert a list of lists of token ids into a list of strings by calling decode.",Xs,ne,gt,Qs,Nn,xd=`Converts a sequence of ids in a string, using the tokenizer and vocabulary with options to remove special
tokens and clean up tokenization spaces.`,Ys,En,Td="Similar to doing <code>self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))</code>.",Os,oe,kt,Ks,Zn,vd="Converts a string to a sequence of ids (integer), using the tokenizer and vocabulary.",ea,Dn,yd="Same as doing <code>self.convert_tokens_to_ids(self.tokenize(text))</code>.",ta,re,bt,na,Hn,wd="Upload the tokenizer files to the 🤗 Model Hub.",oa,Me,ra,Ie,xt,sa,Gn,zd=`Converts a single index or a sequence of indices in a token or a sequence of tokens, using the vocabulary and
added tokens.`,aa,Fe,Tt,ia,Rn,$d=`Converts a token string (or a sequence of tokens) in a single integer id (or a sequence of ids), using the
vocabulary.`,da,Le,vt,ca,An,Pd="Returns the added tokens in the vocabulary as a dictionary of token to index.",la,se,yt,pa,Sn,Cd="Returns the number of added tokens when encoding a sequence with special tokens.",ma,je,ha,ae,wt,ua,Xn,qd=`Define the truncation and the padding strategies for fast tokenizers (provided by HuggingFace tokenizers
...
as the current one.`,cr,$t,lr,C,Pt,ka,On,Fd=`Holds the output of the <a href="/docs/transformers/main/zh/main_classes/tokenizer#transformers.PreTrainedTokenizerFast.__call__"><strong>call</strong>()</a>,
<a href="/docs/transformers/main/zh/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.encode_plus">encode_plus()</a> and
<a href="/docs/transformers/main/zh/internal/tokenization_utils#transformers.PreTrainedTokenizerBase.batch_encode_plus">batch_encode_plus()</a> methods (tokens, attention_masks, etc).`,ba,Kn,Ld=`This class is derived from a python dictionary and can be used as a dictionary. In addition, this class exposes
utility methods to map from word/character space to token space.`,xa,Z,Ct,Ta,eo,jd=`Get the index of the token in the encoded output comprising a character in the original string for a sequence
...
for a single sequence or the first sequence of a pair, and <code>1</code> for the second sequence of a pair`,Ga,bo,Od="Can be called as:",Ra,xo,Kd="<li><code>self.token_to_sequence(token_index)</code> if batch size is 1</li> <li><code>self.token_to_sequence(batch_index, token_index)</code> if batch size is greater than 1</li>",Aa,To,ec=`This method is particularly suited when the input sequences are provided as pre-tokenized sequences (i.e.,
...
<code>&gt;= 7.5</code> (Volta).`,name:"pad_to_multiple_of"},{anchor:"transformers.PreTrainedTokenizer.__call__.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/main/zh/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
...
If set will pad the sequence to a multiple of the provided value. Requires <code>padding</code> to be activated.
This is especially useful to enable the use of Tensor Cores on NVIDIA hardware with compute capability
<code>&gt;= 7.5</code> (Volta).`,name:"pad_to_multiple_of"},{anchor:"transformers.PreTrainedTokenizer.encode.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/main/zh/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
If set, will return tensors instead of list of python integers. Acceptable values are:</p>
<ul>
<li><code>&apos;tf&apos;</code>: Return TensorFlow <code>tf.constant</code> objects.</li>
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
...
If set will pad the sequence to a multiple of the provided value. Requires <code>padding</code> to be activated.
This is especially useful to enable the use of Tensor Cores on NVIDIA hardware with compute capability
<code>&gt;= 7.5</code> (Volta).`,name:"pad_to_multiple_of"},{anchor:"transformers.PreTrainedTokenizerFast.__call__.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/main/zh/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
If set, will return tensors instead of list of python integers. Acceptable values are:</p>
<ul>
<li><code>&apos;tf&apos;</code>: Return TensorFlow <code>tf.constant</code> objects.</li>
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
...
If set will pad the sequence to a multiple of the provided value. Requires <code>padding</code> to be activated.
This is especially useful to enable the use of Tensor Cores on NVIDIA hardware with compute capability
<code>&gt;= 7.5</code> (Volta).`,name:"pad_to_multiple_of"},{anchor:"transformers.PreTrainedTokenizerFast.encode.return_tensors",description:`<strong>return_tensors</strong> (<code>str</code> or <a href="/docs/transformers/main/zh/internal/file_utils#transformers.TensorType">TensorType</a>, <em>optional</em>) &#x2014;
If set, will return tensors instead of list of python integers. Acceptable values are:</p>
<ul>
<li><code>&apos;tf&apos;</code>: Return TensorFlow <code>tf.constant</code> objects.</li>
<li><code>&apos;pt&apos;</code>: Return PyTorch <code>torch.Tensor</code> objects.</li>
...
<p><a
  href="/docs/transformers/main/zh/main_classes/tokenizer#transformers.PreTrainedTokenizerFast"
...
<p><a
  href="/docs/transformers/main/zh/internal/tokenization_utils#transformers.CharSpan"
>CharSpan</a></p>
...
<p>(<a
  href="/docs/transformers/main/zh/internal/tokenization_utils#transformers.TokenSpan"
...
<p><code>List[Optional[int]]</code></p>
`}}),{c(){c=r("meta"),I=n(),k=r("p"),_=n(),l(P.$$.fragment),i=n(),M=r("p"),M.innerHTML=ki,Ko=n(),Ze=r("ol"),Ze.innerHTML=bi,er=n(),De=r("p"),De.innerHTML=xi,tr=n(),He=r("p"),He.innerHTML=Ti,nr=n(),Ge=r("ul"),Ge.innerHTML=vi,or=n(),Re=r("p"),Re.innerHTML=yi,rr=n(),l(Ae.$$.fragment),sr=n(),b=r("div"),l(Se.$$.fragment),qr=n(),Ht=r("p"),Ht.textContent=wi,Mr=n(),Gt=r("p"),Gt.innerHTML=zi,Ir=n(),Rt=r("p"),Rt.textContent=$i,Fr=n(),At=r("p"),At.textContent=Pi,Lr=n(),St=r("p"),St.textContent=Ci,jr=n(),Xt=r("ul"),Xt.innerHTML=qi,Wr=n(),fe=r("div"),l(Xe.$$.fragment),Jr=n(),Qt=r("p"),Qt.textContent=Mi,Ur=n(),N=r("div"),l(Qe.$$.fragment),Br=n(),Yt=r("p"),Yt.textContent=Ii,Vr=n(),Ot=r("p"),Ot.textContent=Fi,Nr=n(),Kt=r("p"),Kt.innerHTML=Li,Er=n(),l(_e.$$.fragment),Zr=n(),F=r("div"),l(Ye.$$.fragment),Dr=n(),en=r("p"),en.textContent=ji,Hr=n(),tn=r("p"),tn.textContent=Wi,Gr=n(),nn=r("p"),nn.innerHTML=Ji,Rr=n(),on=r("p"),on.innerHTML=Ui,Ar=n(),rn=r("ul"),rn.innerHTML=Bi,Sr=n(),sn=r("p"),sn.innerHTML=Vi,Xr=n(),l(ge.$$.fragment),Qr=n(),ke=r("div"),l(Oe.$$.fragment),Yr=n(),an=r("p"),an.innerHTML=Ni,Or=n(),be=r("div"),l(Ke.$$.fragment),Kr=n(),dn=r("p"),dn.textContent=Ei,es=n(),Q=r("div"),l(et.$$.fragment),ts=n(),cn=r("p"),cn.textContent=Zi,ns=n(),ln=r("p"),ln.innerHTML=Di,os=n(),Y=r("div"),l(tt.$$.fragment),rs=n(),pn=r("p"),pn.textContent=Hi,ss=n(),mn=r("p"),mn.innerHTML=Gi,as=n(),O=r("div"),l(nt.$$.fragment),is=n(),hn=r("p"),hn.textContent=Ri,ds=n(),l(xe.$$.fragment),cs=n(),Te=r("div"),l(ot.$$.fragment),ls=n(),un=r("p"),un.textContent=Ai,ps=n(),ve=r("div"),l(rt.$$.fragment),ms=n(),fn=r("p"),fn.textContent=Si,hs=n(),ye=r("div"),l(st.$$.fragment),us=n(),_n=r("p"),_n.textContent=Xi,fs=n(),K=r("div"),l(at.$$.fragment),_s=n(),gn=r("p"),gn.textContent=Qi,gs=n(),l(we.$$.fragment),ks=n(),ee=r("div"),l(it.$$.fragment),bs=n(),kn=r("p"),kn.textContent=Yi,xs=n(),bn=r("p"),bn.innerHTML=Oi,Ts=n(),te=r("div"),l(dt.$$.fragment),vs=n(),xn=r("p"),xn.textContent=Ki,ys=n(),Tn=r("p"),Tn.textContent=ed,ar=n(),l(ct.$$.fragment),ir=n(),lt=r("p"),lt.innerHTML=td,dr=n(),x=r("div"),l(pt.$$.fragment),ws=n(),vn=r("p"),vn.textContent=nd,zs=n(),yn=r("p"),yn.innerHTML=od,$s=n(),wn=r("p"),wn.textContent=rd,Ps=n(),zn=r("p"),zn.textContent=sd,Cs=n(),$n=r("p"),$n.textContent=ad,qs=n(),Pn=r("ul"),Pn.innerHTML=id,Ms=n(),ze=r("div"),l(mt.$$.fragment),Is=n(),Cn=r("p"),Cn.textContent=dd,Fs=n(),E=r("div"),l(ht.$$.fragment),Ls=n(),qn=r("p"),qn.textContent=cd,js=n(),Mn=r("p"),Mn.textContent=ld,Ws=n(),In=r("p"),In.innerHTML=pd,Js=n(),l($e.$$.fragment),Us=n(),L=r("div"),l(ut.$$.fragment),Bs=n(),Fn=r("p"),Fn.textContent=md,Vs=n(),Ln=r("p"),Ln.textContent=hd,Ns=n(),jn=r("p"),jn.innerHTML=ud,Es=n(),Wn=r("p"),Wn.innerHTML=fd,Zs=n(),Jn=r("ul"),Jn.innerHTML=_d,Ds=n(),Un=r("p"),Un.innerHTML=gd,Hs=n(),l(Pe.$$.fragment),Gs=n(),Ce=r("div"),l(ft.$$.fragment),Rs=n(),Bn=r("p"),Bn.innerHTML=kd,As=n(),qe=r("div"),l(_t.$$.fragment),Ss=n(),Vn=r("p"),Vn.textContent=bd,Xs=n(),ne=r("div"),l(gt.$$.fragment),Qs=n(),Nn=r("p"),Nn.textContent=xd,Ys=n(),En=r("p"),En.innerHTML=Td,Os=n(),oe=r("div"),l(kt.$$.fragment),Ks=n(),Zn=r("p"),Zn.textContent=vd,ea=n(),Dn=r("p"),Dn.innerHTML=yd,ta=n(),re=r("div"),l(bt.$$.fragment),na=n(),Hn=r("p"),Hn.textContent=wd,oa=n(),l(Me.$$.fragment),ra=n(),Ie=r("div"),l(xt.$$.fragment),sa=n(),Gn=r("p"),Gn.textContent=zd,aa=n(),Fe=r("div"),l(Tt.$$.fragment),ia=n(),Rn=r("p"),Rn.textContent=$d,da=n(),Le=r("div"),l(vt.$$.fragment),ca=n(),An=r("p"),An.textContent=Pd,la=n(),se=r("div"),l(yt.$$.fragment),pa=n(),Sn=r("p"),Sn.textContent=Cd,ma=n(),l(je.$$.fragment),ha=n(),ae=r("div"),l(wt.$$.fragment),ua=n(),Xn=r("p"),Xn.textContent=qd,fa=n(),Qn=r("p"),Qn.textContent=Md,_a=n(),We=r("div"),l(zt.$$.fragment),ga=n(),Yn=r("p"),Yn.textContent=Id,cr=n(),l($t.$$.fragment),lr=n(),C=r("div"),l(Pt.$$.fragment),ka=n(),On=r("p"),On.innerHTML=Fd,ba=n(),Kn=r("p"),Kn.textContent=Ld,xa=n(),Z=r("div"),l(Ct.$$.fragment),Ta=n(),eo=r("p"),eo.textContent=jd,va=n(),to=r("p"),to.textContent=Wd,ya=n(),no=r("ul"),no.innerHTML=Jd,wa=n(),oo=r("p"),oo.textContent=Ud,za=n(),D=r("div"),l(qt.$$.fragment),$a=n(),ro=r("p"),ro.textContent=Bd,Pa=n(),so=r("p"),so.textContent=Vd,Ca=n(),ao=r("ul"),ao.innerHTML=Nd,qa=n(),io=r("p"),io.textContent=Ed,Ma=n(),Je=r("div"),l(Mt.$$.fragment),Ia=n(),co=r("p"),co.textContent=Zd,Fa=n(),ie=r("div"),l(It.$$.fragment),La=n(),lo=r("p"),lo.textContent=Dd,ja=n(),po=r("ul"),po.innerHTML=Hd,Wa=n(),Ue=r("div"),l(Ft.$$.fragment),Ja=n(),mo=r("p"),mo.innerHTML=Gd,Ua=n(),U=r("div"),l(Lt.$$.fragment),Ba=n(),ho=r("p"),ho.textContent=Rd,Va=n(),uo=r("p"),uo.innerHTML=Ad,Na=n(),fo=r("ul"),fo.innerHTML=Sd,Ea=n(),_o=r("p"),_o.textContent=Xd,Za=n(),go=r("ul"),go.innerHTML=Qd,Da=n(),H=r("div"),l(jt.$$.fragment),Ha=n(),ko=r("p"),ko.innerHTML=Yd,Ga=n(),bo=r("p"),bo.textContent=Od,Ra=n(),xo=r("ul"),xo.innerHTML=Kd,Aa=n(),To=r("p"),To.textContent=ec,Sa=n(),G=r("div"),l(Wt.$$.fragment),Xa=n(),vo=r("p"),vo.textContent=tc,Qa=n(),yo=r("p"),yo.textContent=nc,Ya=n(),wo=r("ul"),wo.innerHTML=oc,Oa=n(),zo=r("p"),zo.textContent=rc,Ka=n(),Be=r("div"),l(Jt.$$.fragment),ei=n(),$o=r("p"),$o.textContent=sc,ti=n(),Ve=r("div"),l(Ut.$$.fragment),ni=n(),Po=r("p"),Po.textContent=ac,oi=n(),B=r("div"),l(Bt.$$.fragment),ri=n(),Co=r("p"),Co.textContent=ic,si=n(),qo=r("p"),qo.textContent=dc,ai=n(),Mo=r("ul"),Mo.innerHTML=cc,ii=n(),Io=r("p"),Io.textContent=lc,di=n(),Fo=r("ul"),Fo.innerHTML=pc,ci=n(),J=r("div"),l(Vt.$$.fragment),li=n(),Lo=r("p"),Lo.textContent=mc,pi=n(),jo=r("p"),jo.innerHTML=hc,mi=n(),Wo=r("ul"),Wo.innerHTML=uc,hi=n(),Jo=r("p"),Jo.textContent=fc,ui=n(),Uo=r("ul"),Uo.innerHTML=_c,fi=n(),Bo=r("p"),Bo.textContent=gc,_i=n(),Ne=r("div"),l(Nt.$$.fragment),gi=n(),Vo=r("p"),Vo.textContent=kc,pr=n(),Oo=r("p"),this.h()},l(t){const g=wc("svelte-u9bgzb",document.head);c=s(g,"META",{name:!0,content:!0}),g.forEach(d),I=o(t),k=s(t,"P",{}),T(k).forEach(d),_=o(t),p(P.$$.fragment,t),i=o(t),M=s(t,"P",{"data-svelte-h":!0}),a(M)!=="svelte-1lgw8ut"&&(M.innerHTML=ki),Ko=o(t),Ze=s(t,"OL",{"data-svelte-h":!0}),a(Ze)!=="svelte-1n20hjv"&&(Ze.innerHTML=bi),er=o(t),De=s(t,"P",{"data-svelte-h":!0}),a(De)!=="svelte-hhy2e"&&(De.innerHTML=xi),tr=o(t),He=s(t,"P",{"data-svelte-h":!0}),a(He)!=="svelte-bvcvs2"&&(He.innerHTML=Ti),nr=o(t),Ge=s(t,"UL",{"data-svelte-h":!0}),a(Ge)!=="svelte-m9xzbe"&&(Ge.innerHTML=vi),or=o(t),Re=s(t,"P",{"data-svelte-h":!0}),a(Re)!=="svelte-30swvn"&&(Re.innerHTML=yi),rr=o(t),p(Ae.$$.fragment,t),sr=o(t),b=s(t,"DIV",{class:!0});var y=T(b);p(Se.$$.fragment,y),qr=o(y),Ht=s(y,"P",{"data-svelte-h":!0}),a(Ht)!=="svelte-1vieurq"&&(Ht.textContent=wi),Mr=o(y),Gt=s(y,"P",{"data-svelte-h":!0}),a(Gt)!=="svelte-1wcfm9u"&&(Gt.innerHTML=zi),Ir=o(y),Rt=s(y,"P",{"data-svelte-h":!0}),a(Rt)!=="svelte-y6enlf"&&(Rt.textContent=$i),Fr=o(y),At=s(y,"P",{"data-svelte-h":!0}),a(At)!=="svelte-abl5qq"&&(At.textContent=Pi),Lr=o(y),St=s(y,"P",{"data-svelte-h":!0}),a(St)!=="svelte-1ixo79u"&&(St.textContent=Ci),jr=o(y),Xt=s(y,"UL",{"data-svelte-h":!0}),a(Xt)!=="svelte-jmmc41"&&(Xt.innerHTML=qi),Wr=o(y),fe=s(y,"DIV",{class:!0});var Et=T(fe);p(Xe.$$.fragment,Et),Jr=o(Et),Qt=s(Et,"P",{"data-svelte-h":!0}),a(Qt)!=="svelte-kpxj0c"&&(Qt.textContent=Mi),Et.forEach(d),Ur=o(y),N=s(y,"DIV",{class:!0});var A=T(N);p(Qe.$$.fragment,A),Br=o(A),Yt=s(A,"P",{"data-svelte-h":!0}),a(Yt)!=="svelte-14rotd7"&&(Yt.textContent=Ii),Vr=o(A),Ot=s(A,"P",{"data-svelte-h":!0}),a(Ot)!=="svelte-j0w5r1"&&(Ot.textContent=Fi),Nr=o(A),Kt=s(A,"P",{"data-svelte-h":!0}),a(Kt)!=="svelte-14mnffo"&&(Kt.innerHTML=Li),Er=o(A),p(_e.$$.fragment,A),A.forEach(d),Zr=o(y),F=s(y,"DIV",{class:!0});var j=T(F);p(Ye.$$.fragment,j),Dr=o(j),en=s(j,"P",{"data-svelte-h":!0}),a(en)!=="svelte-1j8s0i5"&&(en.textContent=ji),Hr=o(j),tn=s(j,"P",{"data-svelte-h":!0}),a(tn)!=="svelte-1w3ayx9"&&(tn.textContent=Wi),Gr=o(j),nn=s(j,"P",{"data-svelte-h":!0}),a(nn)!=="svelte-14mnffo"&&(nn.innerHTML=Ji),Rr=o(j),on=s(j,"P",{"data-svelte-h":!0}),a(on)!=="svelte-5hxtpc"&&(on.innerHTML=Ui),Ar=o(j),rn=s(j,"UL",{"data-svelte-h":!0}),a(rn)!=="svelte-1pes0uj"&&(rn.innerHTML=Bi),Sr=o(j),sn=s(j,"P",{"data-svelte-h":!0}),a(sn)!=="svelte-1butrf6"&&(sn.innerHTML=Vi),Xr=o(j),p(ge.$$.fragment,j),j.forEach(d),Qr=o(y),ke=s(y,"DIV",{class:!0});var Zt=T(ke);p(Oe.$$.fragment,Zt),Yr=o(Zt),an=s(Zt,"P",{"data-svelte-h":!0}),a(an)!=="svelte-wjbfy4"&&(an.innerHTML=Ni),Zt.forEach(d),Or=o(y),be=s(y,"DIV",{class:!0});var Dt=T(be);p(Ke.$$.fragment,Dt),Kr=o(Dt),dn=s(Dt,"P",{"data-svelte-h":!0}),a(dn)!=="svelte-1deng2j"&&(dn.textContent=Ei),Dt.forEach(d),es=o(y),Q=s(y,"DIV",{class:!0});var he=T(Q);p(et.$$.fragment,he),ts=o(he),cn=s(he,"P",{"data-svelte-h":!0}),a(cn)!=="svelte-vbfkpu"&&(cn.textContent=Zi),ns=o(he),ln=s(he,"P",{"data-svelte-h":!0}),a(ln)!=="svelte-125uxon"&&(ln.innerHTML=Di),he.forEach(d),os=o(y),Y=s(y,"DIV",{class:!0});var ue=T(Y);p(tt.$$.fragment,ue),rs=o(ue),pn=s(ue,"P",{"data-svelte-h":!0}),a(pn)!=="svelte-12b8hzo"&&(pn.textContent=Hi),ss=o(ue),mn=s(ue,"P",{"data-svelte-h":!0}),a(mn)!=="svelte-1kyhveh"&&(mn.innerHTML=Gi),ue.forEach(d),as=o(y),O=s(y,"DIV",{class:!0});var No=T(O);p(nt.$$.fragment,No),is=o(No),hn=s(No,"P",{"data-svelte-h":!0}),a(hn)!=="svelte-tpmkl3"&&(hn.textContent=Ri),ds=o(No),p(xe.$$.fragment,No),No.forEach(d),cs=o(y),Te=s(y,"DIV",{class:!0});var hr=T(Te);p(ot.$$.fragment,hr),ls=o(hr),un=s(hr,"P",{"data-svelte-h":!0}),a(un)!=="svelte-cx157h"&&(un.textContent=Ai),hr.forEach(d),ps=o(y),ve=s(y,"DIV",{class:!0});var ur=T(ve);p(rt.$$.fragment,ur),ms=o(ur),fn=s(ur,"P",{"data-svelte-h":!0}),a(fn)!=="svelte-1urz5jj"&&(fn.textContent=Si),ur.forEach(d),hs=o(y),ye=s(y,"DIV",{class:!0});var fr=T(ye);p(st.$$.fragment,fr),us=o(fr),_n=s(fr,"P",{"data-svelte-h":!0}),a(_n)!=="svelte-2yfcci"&&(_n.textContent=Xi),fr.forEach(d),fs=o(y),K=s(y,"DIV",{class:!0});var Eo=T(K);p(at.$$.fragment,Eo),_s=o(Eo),gn=s(Eo,"P",{"data-svelte-h":!0}),a(gn)!=="svelte-1oqr1g4"&&(gn.textContent=Qi),gs=o(Eo),p(we.$$.fragment,Eo),Eo.forEach(d),ks=o(y),ee=s(y,"DIV",{class:!0});var Zo=T(ee);p(it.$$.fragment,Zo),bs=o(Zo),kn=s(Zo,"P",{"data-svelte-h":!0}),a(kn)!=="svelte-suiszn"&&(kn.textContent=Yi),xs=o(Zo),bn=s(Zo,"P",{"data-svelte-h":!0}),a(bn)!=="svelte-1bw0rb5"&&(bn.innerHTML=Oi),Zo.forEach(d),Ts=o(y),te=s(y,"DIV",{class:!0});var Do=T(te);p(dt.$$.fragment,Do),vs=o(Do),xn=s(Do,"P",{"data-svelte-h":!0}),a(xn)!=="svelte-sso1qb"&&(xn.textContent=Ki),ys=o(Do),Tn=s(Do,"P",{"data-svelte-h":!0}),a(Tn)!=="svelte-1i4xsf5"&&(Tn.textContent=ed),Do.forEach(d),y.forEach(d),ar=o(t),p(ct.$$.fragment,t),ir=o(t),lt=s(t,"P",{"data-svelte-h":!0}),a(lt)!=="svelte-wr8uaz"&&(lt.innerHTML=td),dr=o(t),x=s(t,"DIV",{class:!0});var z=T(x);p(pt.$$.fragment,z),ws=o(z),vn=s(z,"P",{"data-svelte-h":!0}),a(vn)!=="svelte-1e1i5yj"&&(vn.textContent=nd),zs=o(z),yn=s(z,"P",{"data-svelte-h":!0}),a(yn)!=="svelte-1wcfm9u"&&(yn.innerHTML=od),$s=o(z),wn=s(z,"P",{"data-svelte-h":!0}),a(wn)!=="svelte-99yswb"&&(wn.textContent=rd),Ps=o(z),zn=s(z,"P",{"data-svelte-h":!0}),a(zn)!=="svelte-1y9tnev"&&(zn.textContent=sd),Cs=o(z),$n=s(z,"P",{"data-svelte-h":!0}),a($n)!=="svelte-1ixo79u"&&($n.textContent=ad),qs=o(z),Pn=s(z,"UL",{"data-svelte-h":!0}),a(Pn)!=="svelte-jmmc41"&&(Pn.innerHTML=id),Ms=o(z),ze=s(z,"DIV",{class:!0});var _r=T(ze);p(mt.$$.fragment,_r),Is=o(_r),Cn=s(_r,"P",{"data-svelte-h":!0}),a(Cn)!=="svelte-kpxj0c"&&(Cn.textContent=dd),_r.forEach(d),Fs=o(z),E=s(z,"DIV",{class:!0});var de=T(E);p(ht.$$.fragment,de),Ls=o(de),qn=s(de,"P",{"data-svelte-h":!0}),a(qn)!=="svelte-14rotd7"&&(qn.textContent=cd),js=o(de),Mn=s(de,"P",{"data-svelte-h":!0}),a(Mn)!=="svelte-j0w5r1"&&(Mn.textContent=ld),Ws=o(de),In=s(de,"P",{"data-svelte-h":!0}),a(In)!=="svelte-14mnffo"&&(In.innerHTML=pd),Js=o(de),p($e.$$.fragment,de),de.forEach(d),Us=o(z),L=s(z,"DIV",{class:!0});var V=T(L);p(ut.$$.fragment,V),Bs=o(V),Fn=s(V,"P",{"data-svelte-h":!0}),a(Fn)!=="svelte-1j8s0i5"&&(Fn.textContent=md),Vs=o(V),Ln=s(V,"P",{"data-svelte-h":!0}),a(Ln)!=="svelte-1w3ayx9"&&(Ln.textContent=hd),Ns=o(V),jn=s(V,"P",{"data-svelte-h":!0}),a(jn)!=="svelte-14mnffo"&&(jn.innerHTML=ud),Es=o(V),Wn=s(V,"P",{"data-svelte-h":!0}),a(Wn)!=="svelte-5hxtpc"&&(Wn.innerHTML=fd),Zs=o(V),Jn=s(V,"UL",{"data-svelte-h":!0}),a(Jn)!=="svelte-1pes0uj"&&(Jn.innerHTML=_d),Ds=o(V),Un=s(V,"P",{"data-svelte-h":!0}),a(Un)!=="svelte-1butrf6"&&(Un.innerHTML=gd),Hs=o(V),p(Pe.$$.fragment,V),V.forEach(d),Gs=o(z),Ce=s(z,"DIV",{class:!0});var gr=T(Ce);p(ft.$$.fragment,gr),Rs=o(gr),Bn=s(gr,"P",{"data-svelte-h":!0}),a(Bn)!=="svelte-wjbfy4"&&(Bn.innerHTML=kd),gr.forEach(d),As=o(z),qe=s(z,"DIV",{class:!0});var kr=T(qe);p(_t.$$.fragment,kr),Ss=o(kr),Vn=s(kr,"P",{"data-svelte-h":!0}),a(Vn)!=="svelte-1deng2j"&&(Vn.textContent=bd),kr.forEach(d),Xs=o(z),ne=s(z,"DIV",{class:!0});var Ho=T(ne);p(gt.$$.fragment,Ho),Qs=o(Ho),Nn=s(Ho,"P",{"data-svelte-h":!0}),a(Nn)!=="svelte-vbfkpu"&&(Nn.textContent=xd),Ys=o(Ho),En=s(Ho,"P",{"data-svelte-h":!0}),a(En)!=="svelte-125uxon"&&(En.innerHTML=Td),Ho.forEach(d),Os=o(z),oe=s(z,"DIV",{class:!0});var Go=T(oe);p(kt.$$.fragment,Go),Ks=o(Go),Zn=s(Go,"P",{"data-svelte-h":!0}),a(Zn)!=="svelte-12b8hzo"&&(Zn.textContent=vd),ea=o(Go),Dn=s(Go,"P",{"data-svelte-h":!0}),a(Dn)!=="svelte-1kyhveh"&&(Dn.innerHTML=yd),Go.forEach(d),ta=o(z),re=s(z,"DIV",{class:!0});var Ro=T(re);p(bt.$$.fragment,Ro),na=o(Ro),Hn=s(Ro,"P",{"data-svelte-h":!0}),a(Hn)!=="svelte-tpmkl3"&&(Hn.textContent=wd),oa=o(Ro),p(Me.$$.fragment,Ro),Ro.forEach(d),ra=o(z),Ie=s(z,"DIV",{class:!0});var br=T(Ie);p(xt.$$.fragment,br),sa=o(br),Gn=s(br,"P",{"data-svelte-h":!0}),a(Gn)!=="svelte-cx157h"&&(Gn.textContent=zd),br.forEach(d),aa=o(z),Fe=s(z,"DIV",{class:!0});var xr=T(Fe);p(Tt.$$.fragment,xr),ia=o(xr),Rn=s(xr,"P",{"data-svelte-h":!0}),a(Rn)!=="svelte-1urz5jj"&&(Rn.textContent=$d),xr.forEach(d),da=o(z),Le=s(z,"DIV",{class:!0});var Tr=T(Le);p(vt.$$.fragment,Tr),ca=o(Tr),An=s(Tr,"P",{"data-svelte-h":!0}),a(An)!=="svelte-17grjhy"&&(An.textContent=Pd),Tr.forEach(d),la=o(z),se=s(z,"DIV",{class:!0});var Ao=T(se);p(yt.$$.fragment,Ao),pa=o(Ao),Sn=s(Ao,"P",{"data-svelte-h":!0}),a(Sn)!=="svelte-1oqr1g4"&&(Sn.textContent=Cd),ma=o(Ao),p(je.$$.fragment,Ao),Ao.forEach(d),ha=o(z),ae=s(z,"DIV",{class:!0});var So=T(ae);p(wt.$$.fragment,So),ua=o(So),Xn=s(So,"P",{"data-svelte-h":!0}),a(Xn)!=="svelte-wj61ov"&&(Xn.textContent=qd),fa=o(So),Qn=s(So,"P",{"data-svelte-h":!0}),a(Qn)!=="svelte-1423b5j"&&(Qn.textContent=Md),So.forEach(d),_a=o(z),We=s(z,"DIV",{class:!0});var vr=T(We);p(zt.$$.fragment,vr),ga=o(vr),Yn=s(vr,"P",{"data-svelte-h":!0}),a(Yn)!=="svelte-dk6kyv"&&(Yn.textContent=Id),vr.forEach(d),z.forEach(d),cr=o(t),p($t.$$.fragment,t),lr=o(t),C=s(t,"DIV",{class:!0});var q=T(C);p(Pt.$$.fragment,q),ka=o(q),On=s(q,"P",{"data-svelte-h":!0}),a(On)!=="svelte-2v370m"&&(On.innerHTML=Fd),ba=o(q),Kn=s(q,"P",{"data-svelte-h":!0}),a(Kn)!=="svelte-1df8ukr"&&(Kn.textContent=Ld),xa=o(q),Z=s(q,"DIV",{class:!0});var ce=T(Z);p(Ct.$$.fragment,ce),Ta=o(ce),eo=s(ce,"P",{"data-svelte-h":!0}),a(eo)!=="svelte-1gpnz9t"&&(eo.textContent=jd),va=o(ce),to=s(ce,"P",{"data-svelte-h":!0}),a(to)!=="svelte-hoi93q"&&(to.textContent=Wd),ya=o(ce),no=s(ce,"UL",{"data-svelte-h":!0}),a(no)!=="svelte-i7p8st"&&(no.innerHTML=Jd),wa=o(ce),oo=s(ce,"P",{"data-svelte-h":!0}),a(oo)!=="svelte-udqgev"&&(oo.textContent=Ud),ce.forEach(d),za=o(q),D=s(q,"DIV",{class:!0});var le=T(D);p(qt.$$.fragment,le),$a=o(le),ro=s(le,"P",{"data-svelte-h":!0}),a(ro)!=="svelte-mtqdue"&&(ro.textContent=Bd),Pa=o(le),so=s(le,"P",{"data-svelte-h":!0}),a(so)!=="svelte-hoi93q"&&(so.textContent=Vd),Ca=o(le),ao=s(le,"UL",{"data-svelte-h":!0}),a(ao)!=="svelte-2vo0y6"&&(ao.innerHTML=Nd),qa=o(le),io=s(le,"P",{"data-svelte-h":!0}),a(io)!=="svelte-udqgev"&&(io.textContent=Ed),le.forEach(d),Ma=o(q),Je=s(q,"DIV",{class:!0});var yr=T(Je);p(Mt.$$.fragment,yr),Ia=o(yr),co=s(yr,"P",{"data-svelte-h":!0}),a(co)!=="svelte-pxfh9u"&&(co.textContent=Zd),yr.forEach(d),Fa=o(q),ie=s(q,"DIV",{class:!0});var Xo=T(ie);p(It.$$.fragment,Xo),La=o(Xo),lo=s(Xo,"P",{"data-svelte-h":!0}),a(lo)!=="svelte-1839ko1"&&(lo.textContent=Dd),ja=o(Xo),po=s(Xo,"UL",{"data-svelte-h":!0}),a(po)!=="svelte-1ap7xk7"&&(po.innerHTML=Hd),Xo.forEach(d),Wa=o(q),Ue=s(q,"DIV",{class:!0});var wr=T(Ue);p(Ft.$$.fragment,wr),Ja=o(wr),mo=s(wr,"P",{"data-svelte-h":!0}),a(mo)!=="svelte-8ewnfk"&&(mo.innerHTML=Gd),wr.forEach(d),Ua=o(q),U=s(q,"DIV",{class:!0});var S=T(U);p(Lt.$$.fragment,S),Ba=o(S),ho=s(S,"P",{"data-svelte-h":!0}),a(ho)!=="svelte-xav75j"&&(ho.textContent=Rd),Va=o(S),uo=s(S,"P",{"data-svelte-h":!0}),a(uo)!=="svelte-vabr2w"&&(uo.innerHTML=Ad),Na=o(S),fo=s(S,"UL",{"data-svelte-h":!0}),a(fo)!=="svelte-4fpj7o"&&(fo.innerHTML=Sd),Ea=o(S),_o=s(S,"P",{"data-svelte-h":!0}),a(_o)!=="svelte-hoi93q"&&(_o.textContent=Xd),Za=o(S),go=s(S,"UL",{"data-svelte-h":!0}),a(go)!=="svelte-10t7hv1"&&(go.innerHTML=Qd),S.forEach(d),Da=o(q),H=s(q,"DIV",{class:!0});var pe=T(H);p(jt.$$.fragment,pe),Ha=o(pe),ko=s(pe,"P",{"data-svelte-h":!0}),a(ko)!=="svelte-gouuon"&&(ko.innerHTML=Yd),Ga=o(pe),bo=s(pe,"P",{"data-svelte-h":!0}),a(bo)!=="svelte-hoi93q"&&(bo.textContent=Od),Ra=o(pe),xo=s(pe,"UL",{"data-svelte-h":!0}),a(xo)!=="svelte-q52scs"&&(xo.innerHTML=Kd),Aa=o(pe),To=s(pe,"P",{"data-svelte-h":!0}),a(To)!=="svelte-1fj0zmd"&&(To.textContent=ec),pe.forEach(d),Sa=o(q),G=s(q,"DIV",{class:!0});var me=T(G);p(Wt.$$.fragment,me),Xa=o(me),vo=s(me,"P",{"data-svelte-h":!0}),a(vo)!=="svelte-a0a2o0"&&(vo.textContent=tc),Qa=o(me),yo=s(me,"P",{"data-svelte-h":!0}),a(yo)!=="svelte-hoi93q"&&(yo.textContent=nc),Ya=o(me),wo=s(me,"UL",{"data-svelte-h":!0}),a(wo)!=="svelte-vbk04m"&&(wo.innerHTML=oc),Oa=o(me),zo=s(me,"P",{"data-svelte-h":!0}),a(zo)!=="svelte-1fj0zmd"&&(zo.textContent=rc),me.forEach(d),Ka=o(q),Be=s(q,"DIV",{class:!0});var zr=T(Be);p(Jt.$$.fragment,zr),ei=o(zr),$o=s(zr,"P",{"data-svelte-h":!0}),a($o)!=="svelte-or6vgj"&&($o.textContent=sc),zr.forEach(d),ti=o(q),Ve=s(q,"DIV",{class:!0});var $r=T(Ve);p(Ut.$$.fragment,$r),ni=o($r),Po=s($r,"P",{"data-svelte-h":!0}),a(Po)!=="svelte-1xfwjqh"&&(Po.textContent=ac),$r.forEach(d),oi=o(q),B=s(q,"DIV",{class:!0});var X=T(B);p(Bt.$$.fragment,X),ri=o(X),Co=s(X,"P",{"data-svelte-h":!0}),a(Co)!=="svelte-1p4j7cm"&&(Co.textContent=ic),si=o(X),qo=s(X,"P",{"data-svelte-h":!0}),a(qo)!=="svelte-1m5vplt"&&(qo.textContent=dc),ai=o(X),Mo=s(X,"UL",{"data-svelte-h":!0}),a(Mo)!=="svelte-tivk04"&&(Mo.innerHTML=cc),ii=o(X),Io=s(X,"P",{"data-svelte-h":!0}),a(Io)!=="svelte-hoi93q"&&(Io.textContent=lc),di=o(X),Fo=s(X,"UL",{"data-svelte-h":!0}),a(Fo)!=="svelte-rgo9bl"&&(Fo.innerHTML=pc),X.forEach(d),ci=o(q),J=s(q,"DIV",{class:!0});var R=T(J);p(Vt.$$.fragment,R),li=o(R),Lo=s(R,"P",{"data-svelte-h":!0}),a(Lo)!=="svelte-p6ca34"&&(Lo.textContent=mc),pi=o(R),jo=s(R,"P",{"data-svelte-h":!0}),a(jo)!=="svelte-t08mwa"&&(jo.innerHTML=hc),mi=o(R),Wo=s(R,"UL",{"data-svelte-h":!0}),a(Wo)!=="svelte-adw1ie"&&(Wo.innerHTML=uc),hi=o(R),Jo=s(R,"P",{"data-svelte-h":!0}),a(Jo)!=="svelte-hoi93q"&&(Jo.textContent=fc),ui=o(R),Uo=s(R,"UL",{"data-svelte-h":!0}),a(Uo)!=="svelte-11iunx9"&&(Uo.innerHTML=_c),fi=o(R),Bo=s(R,"P",{"data-svelte-h":!0}),a(Bo)!=="svelte-udqgev"&&(Bo.textContent=gc),R.forEach(d),_i=o(q),Ne=s(q,"DIV",{class:!0});var Pr=T(Ne);p(Nt.$$.fragment,Pr),gi=o(Pr),Vo=s(Pr,"P",{"data-svelte-h":!0}),a(Vo)!=="svelte-1xfwjqh"&&(Vo.textContent=kc),Pr.forEach(d),q.forEach(d),pr=o(t),Oo=s(t,"P",{}),T(Oo).forEach(d),this.h()},h(){v(c,"name","hf:doc:metadata"),v(c,"content",jc),v(fe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(N,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(F,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(ke,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(be,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(Q,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(Y,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(O,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(Te,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(ve,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(ye,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(K,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(ee,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(te,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(b,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(ze,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(E,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(L,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(Ce,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(qe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(ne,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(oe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(re,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(Ie,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(Fe,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(Le,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(se,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(ae,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(We,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(x,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(Z,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(D,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(Je,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(ie,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(Ue,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(U,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(H,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(G,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(Be,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(Ve,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(B,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(J,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(Ne,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8"),v(C,"class","docstring border-l-2 border-t-2 pl-4 pt-3.5 border-gray-100 rounded-tl-xl mb-6 mt-8")},m(t,g){e(document.head,c),$(t,I,g),$(t,k,g),$(t,_,g),m(P,t,g),$(t,i,g),$(t,M,g),$(t,Ko,g),$(t,Ze,g),$(t,er,g),$(t,De,g),$(t,tr,g),$(t,He,g),$(t,nr,g),$(t,Ge,g),$(t,or,g),$(t,Re,g),$(t,rr,g),m(Ae,t,g),$(t,sr,g),$(t,b,g),m(Se,b,null),e(b,qr),e(b,Ht),e(b,Mr),e(b,Gt),e(b,Ir),e(b,Rt),e(b,Fr),e(b,At),e(b,Lr),e(b,St),e(b,jr),e(b,Xt),e(b,Wr),e(b,fe),m(Xe,fe,null),e(fe,Jr),e(fe,Qt),e(b,Ur),e(b,N),m(Qe,N,null),e(N,Br),e(N,Yt),e(N,Vr),e(N,Ot),e(N,Nr),e(N,Kt),e(N,Er),m(_e,N,null),e(b,Zr),e(b,F),m(Ye,F,null),e(F,Dr),e(F,en),e(F,Hr),e(F,tn),e(F,Gr),e(F,nn),e(F,Rr),e(F,on),e(F,Ar),e(F,rn),e(F,Sr),e(F,sn),e(F,Xr),m(ge,F,null),e(b,Qr),e(b,ke),m(Oe,ke,null),e(ke,Yr),e(ke,an),e(b,Or),e(b,be),m(Ke,be,null),e(be,Kr),e(be,dn),e(b,es),e(b,Q),m(et,Q,null),e(Q,ts),e(Q,cn),e(Q,ns),e(Q,ln),e(b,os),e(b,Y),m(tt,Y,null),e(Y,rs),e(Y,pn),e(Y,ss),e(Y,mn),e(b,as),e(b,O),m(nt,O,null),e(O,is),e(O,hn),e(O,ds),m(xe,O,null),e(b,cs),e(b,Te),m(ot,Te,null),e(Te,ls),e(Te,un),e(b,ps),e(b,ve),m(rt,ve,null),e(ve,ms),e(ve,fn),e(b,hs),e(b,ye),m(st,ye,null),e(ye,us),e(ye,_n),e(b,fs),e(b,K),m(at,K,null),e(K,_s),e(K,gn),e(K,gs),m(we,K,null),e(b,ks),e(b,ee),m(it,ee,null),e(ee,bs),e(ee,kn),e(ee,xs),e(ee,bn),e(b,Ts),e(b,te),m(dt,te,null),e(te,vs),e(te,xn),e(te,ys),e(te,Tn),$(t,ar,g),m(ct,t,g),$(t,ir,g),$(t,lt,g),$(t,dr,g),$(t,x,g),m(pt,x,null),e(x,ws),e(x,vn),e(x,zs),e(x,yn),e(x,$s),e(x,wn),e(x,Ps),e(x,zn),e(x,Cs),e(x,$n),e(x,qs),e(x,Pn),e(x,Ms),e(x,ze),m(mt,ze,null),e(ze,Is),e(ze,Cn),e(x,Fs),e(x,E),m(ht,E,null),e(E,Ls),e(E,qn),e(E,js),e(E,Mn),e(E,Ws),e(E,In),e(E,Js),m($e,E,null),e(x,Us),e(x,L),m(ut,L,null),e(L,Bs),e(L,Fn),e(L,Vs),e(L,Ln),e(L,Ns),e(L,jn),e(L,Es),e(L,Wn),e(L,Zs),e(L,Jn),e(L,Ds),e(L,Un),e(L,Hs),m(Pe,L,null),e(x,Gs),e(x,Ce),m(ft,Ce,null),e(Ce,Rs),e(Ce,Bn),e(x,As),e(x,qe),m(_t,qe,null),e(qe,Ss),e(qe,Vn),e(x,Xs),e(x,ne),m(gt,ne,null),e(ne,Qs),e(ne,Nn),e(ne,Ys),e(ne,En),e(x,Os),e(x,oe),m(kt,oe,null),e(oe,Ks),e(oe,Zn),e(oe,ea),e(oe,Dn),e(x,ta),e(x,re),m(bt,re,null),e(re,na),e(re,Hn),e(re,oa),m(Me,re,null),e(x,ra),e(x,Ie),m(xt,Ie,null),e(Ie,sa),e(Ie,Gn),e(x,aa),e(x,Fe),m(Tt,Fe,null),e(Fe,ia),e(Fe,Rn),e(x,da),e(x,Le),m(vt,Le,null),e(Le,ca),e(Le,An),e(x,la),e(x,se),m(yt,se,null),e(se,pa),e(se,Sn),e(se,ma),m(je,se,null),e(x,ha),e(x,ae),m(wt,ae,null),e(ae,ua),e(ae,Xn),e(ae,fa),e(ae,Qn),e(x,_a),e(x,We),m(zt,We,null),e(We,ga),e(We,Yn),$(t,cr,g),m($t,t,g),$(t,lr,g),$(t,C,g),m(Pt,C,null),e(C,ka),e(C,On),e(C,ba),e(C,Kn),e(C,xa),e(C,Z),m(Ct,Z,null),e(Z,Ta),e(Z,eo),e(Z,va),e(Z,to),e(Z,ya),e(Z,no),e(Z,wa),e(Z,oo),e(C,za),e(C,D),m(qt,D,null),e(D,$a),e(D,ro),e(D,Pa),e(D,so),e(D,Ca),e(D,ao),e(D,qa),e(D,io),e(C,Ma),e(C,Je),m(Mt,Je,null),e(Je,Ia),e(Je,co),e(C,Fa),e(C,ie),m(It,ie,null),e(ie,La),e(ie,lo),e(ie,ja),e(ie,po),e(C,Wa),e(C,Ue),m(Ft,Ue,null),e(Ue,Ja),e(Ue,mo),e(C,Ua),e(C,U),m(Lt,U,null),e(U,Ba),e(U,ho),e(U,Va),e(U,uo),e(U,Na),e(U,fo),e(U,Ea),e(U,_o),e(U,Za),e(U,go),e(C,Da),e(C,H),m(jt,H,null),e(H,Ha),e(H,ko),e(H,Ga),e(H,bo),e(H,Ra),e(H,xo),e(H,Aa),e(H,To),e(C,Sa),e(C,G),m(Wt,G,null),e(G,Xa),e(G,vo),e(G,Qa),e(G,yo),e(G,Ya),e(G,wo),e(G,Oa),e(G,zo),e(C,Ka),e(C,Be),m(Jt,Be,null),e(Be,ei),e(Be,$o),e(C,ti),e(C,Ve),m(Ut,Ve,null),e(Ve,ni),e(Ve,Po),e(C,oi),e(C,B),m(Bt,B,null),e(B,ri),e(B,Co),e(B,si),e(B,qo),e(B,ai),e(B,Mo),e(B,ii),e(B,Io),e(B,di),e(B,Fo),e(C,ci),e(C,J),m(Vt,J,null),e(J,li),e(J,Lo),e(J,pi),e(J,jo),e(J,mi),e(J,Wo),e(J,hi),e(J,Jo),e(J,ui),e(J,Uo),e(J,fi),e(J,Bo),e(C,_i),e(C,Ne),m(Nt,Ne,null),e(Ne,gi),e(Ne,Vo),$(t,pr,g),$(t,Oo,g),mr=!0},p(t,[g]){const y={};g&2&&(y.$$scope={dirty:g,ctx:t}),_e.$set(y);const Et={};g&2&&(Et.$$scope={dirty:g,ctx:t}),ge.$set(Et);const A={};g&2&&(A.$$scope={dirty:g,ctx:t}),xe.$set(A);const j={};g&2&&(j.$$scope={dirty:g,ctx:t}),we.$set(j);const Zt={};g&2&&(Zt.$$scope={dirty:g,ctx:t}),$e.$set(Zt);const Dt={};g&2&&(Dt.$$scope={dirty:g,ctx:t}),Pe.$set(Dt);const he={};g&2&&(he.$$scope={dirty:g,ctx:t}),Me.$set(he);const ue={};g&2&&(ue.$$scope={dirty:g,ctx:t}),je.$set(ue)},i(t){mr||(h(P.$$.fragment,t),h(Ae.$$.fragment,t),h(Se.$$.fragment,t),h(Xe.$$.fragment,t),h(Qe.$$.fragment,t),h(_e.$$.fragment,t),h(Ye.$$.fragment,t),h(ge.$$.fragment,t),h(Oe.$$.fragment,t),h(Ke.$$.fragment,t),h(et.$$.fragment,t),h(tt.$$.fragment,t),h(nt.$$.fragment,t),h(xe.$$.fragment,t),h(ot.$$.fragment,t),h(rt.$$.fragment,t),h(st.$$.fragment,t),h(at.$$.fragment,t),h(we.$$.fragment,t),h(it.$$.fragment,t),h(dt.$$.fragment,t),h(ct.$$.fragment,t),h(pt.$$.fragment,t),h(mt.$$.fragment,t),h(ht.$$.fragment,t),h($e.$$.fragment,t),h(ut.$$.fragment,t),h(Pe.$$.fragment,t),h(ft.$$.fragment,t),h(_t.$$.fragment,t),h(gt.$$.fragment,t),h(kt.$$.fragment,t),h(bt.$$.fragment,t),h(Me.$$.fragment,t),h(xt.$$.fragment,t),h(Tt.$$.fragment,t),h(vt.$$.fragment,t),h(yt.$$.fragment,t),h(je.$$.fragment,t),h(wt.$$.fragment,t),h(zt.$$.fragment,t),h($t.$$.fragment,t),h(Pt.$$.fragment,t),h(Ct.$$.fragment,t),h(qt.$$.fragment,t),h(Mt.$$.fragment,t),h(It.$$.fragment,t),h(Ft.$$.fragment,t),h(Lt.$$.fragment,t),h(jt.$$.fragment,t),h(Wt.$$.fragment,t),h(Jt.$$.fragment,t),h(Ut.$$.fragment,t),h(Bt.$$.fragment,t),h(Vt.$$.fragment,t),h(Nt.$$.fragment,t),mr=!0)},o(t){u(P.$$.fragment,t),u(Ae.$$.fragment,t),u(Se.$$.fragment,t),u(Xe.$$.fragment,t),u(Qe.$$.fragment,t),u(_e.$$.fragment,t),u(Ye.$$.fragment,t),u(ge.$$.fragment,t),u(Oe.$$.fragment,t),u(Ke.$$.fragment,t),u(et.$$.fragment,t),u(tt.$$.fragment,t),u(nt.$$.fragment,t),u(xe.$$.fragment,t),u(ot.$$.fragment,t),u(rt.$$.fragment,t),u(st.$$.fragment,t),u(at.$$.fragment,t),u(we.$$.fragment,t),u(it.$$.fragment,t),u(dt.$$.fragment,t),u(ct.$$.fragment,t),u(pt.$$.fragment,t),u(mt.$$.fragment,t),u(ht.$$.fragment,t),u($e.$$.fragment,t),u(ut.$$.fragment,t),u(Pe.$$.fragment,t),u(ft.$$.fragment,t),u(_t.$$.fragment,t),u(gt.$$.fragment,t),u(kt.$$.fragment,t),u(bt.$$.fragment,t),u(Me.$$.fragment,t),u(xt.$$.fragment,t),u(Tt.$$.fragment,t),u(vt.$$.fragment,t),u(yt.$$.fragment,t),u(je.$$.fragment,t),u(wt.$$.fragment,t),u(zt.$$.fragment,t),u($t.$$.fragment,t),u(Pt.$$.fragment,t),u(Ct.$$.fragment,t),u(qt.$$.fragment,t),u(Mt.$$.fragment,t),u(It.$$.fragment,t),u(Ft.$$.fragment,t),u(Lt.$$.fragment,t),u(jt.$$.fragment,t),u(Wt.$$.fragment,t),u(Jt.$$.fragment,t),u(Ut.$$.fragment,t),u(Bt.$$.fragment,t),u(Vt.$$.fragment,t),u(Nt.$$.fragment,t),mr=!1},d(t){t&&(d(I),d(k),d(_),d(i),d(M),d(Ko),d(Ze),d(er),d(De),d(tr),d(He),d(nr),d(Ge),d(or),d(Re),d(rr),d(sr),d(b),d(ar),d(ir),d(lt),d(dr),d(x),d(cr),d(lr),d(C),d(pr),d(Oo)),d(c),f(P,t),f(Ae,t),f(Se),f(Xe),f(Qe),f(_e),f(Ye),f(ge),f(Oe),f(Ke),f(et),f(tt),f(nt),f(xe),f(ot),f(rt),f(st),f(at),f(we),f(it),f(dt),f(ct,t),f(pt),f(mt),f(ht),f($e),f(ut),f(Pe),f(ft),f(_t),f(gt),f(kt),f(bt),f(Me),f(xt),f(Tt),f(vt),f(yt),f(je),f(wt),f(zt),f($t,t),f(Pt),f(Ct),f(qt),f(Mt),f(It),f(Ft),f(Lt),f(jt),f(Wt),f(Jt),f(Ut),f(Bt),f(Vt),f(Nt)}}}const jc='{"title":"Tokenizer","local":"tokenizer","sections":[{"title":"PreTrainedTokenizer","local":"transformers.PreTrainedTokenizer","sections":[],"depth":2},{"title":"PreTrainedTokenizerFast","local":"transformers.PreTrainedTokenizerFast","sections":[],"depth":2},{"title":"BatchEncoding","local":"transformers.BatchEncoding","sections":[],"depth":2}],"depth":1}';function Wc(W){return Tc(()=>{new URLSearchParams(window.location.search).get("fw")}),[]}class Dc extends vc{constructor(c){super(),yc(this,c,Wc,Lc,xc,{})}}export{Dc as component};
